...
var D=Object.defineProperty;var z=(l,e)=>()=>(l&&(e=l(l=0)),e);var F=(l,e)=>{for(var t in e)D(l,t,{get:e[t],enumerable:!0})};var A={};F(A,{HTML5Renderer:()=>v});var v,M=z(()=>{v=class{constructor(e){this.player=e,this.media=e.element}async init(){this.media.controls=!1,this.media.removeAttribute("controls"),this.attachEvents(),this.media.preload=this.player.options.preload,this.media.load()}attachEvents(){this.media.addEventListener("loadedmetadata",()=>{this.player.state.duration=this.media.duration,this.player.emit("loadedmetadata")}),this.media.addEventListener("play",()=>{this.player.state.playing=!0,this.player.state.paused=!1,this.player.state.ended=!1,this.player.emit("play"),this.player.options.onPlay&&this.player.options.onPlay.call(this.player),this.player.options.pauseOthersOnPlay&&this.pauseOtherPlayers()}),this.media.addEventListener("pause",()=>{this.player.state.playing=!1,this.player.state.paused=!0,this.player.emit("pause"),this.player.options.onPause&&this.player.options.onPause.call(this.player)}),this.media.addEventListener("ended",()=>{this.player.state.playing=!1,this.player.state.paused=!0,this.player.state.ended=!0,this.player.emit("ended"),this.player.options.onEnded&&this.player.options.onEnded.call(this.player),this.player.options.loop&&(this.player.seek(0),this.player.play())}),this.media.addEventListener("timeupdate",()=>{this.player.state.currentTime=this.media.currentTime,this.player.emit("timeupdate",this.media.currentTime),this.player.options.onTimeUpdate&&this.player.options.onTimeUpdate.call(this.player,this.media.currentTime)}),this.media.addEventListener("volumechange",()=>{this.player.state.volume=this.media.volume,this.player.state.muted=this.media.muted,this.player.emit("volumechange",this.media.volume),this.player.options.onVolumeChange&&this.player.options.onVolumeChange.call(this.player,this.media.volume)}),this.media.addEventListener("seeking",()=>{this.player.state.seeking=!0,this.player.emit("seeking")}),this.media.addEventListener("seeked",()=>{this.player.state.seeking=!1,this.player.emit("seeked")}),this.media.addEventListener("waiting",()=>{this.player.state.buffering=!0,this.player.emit("waiting")}),this.media.addEventListener("canplay",()=>{this.player.state.buffering=!1,this.player.emit("canplay")}),this.media.addEventListener("progress",()=>{if(this.media.buffered.length>0){let e=this.media.buffered.end(this.media.buffered.length-1);this.player.emit("progress",e)}}),this.media.addEventListener("error",e=>{this.player.handleError(this.media.error)}),this.media.addEventListener("ratechange",()=>{this.player.state.playbackSpeed=this.media.playbackRate,this.player.emit("ratechange",this.media.playbackRate)})}pauseOtherPlayers(){document.querySelectorAll(".vidply-player").forEach(t=>{if(t!==this.player.container){let i=t.querySelector("video, audio");i&&!i.paused&&i.pause()}})}play(){let e=this.media.play();e!==void 0&&e.catch(t=>{this.player.log("Play failed:",t,"warn"),this.player.options.autoplay&&!this.player.state.muted&&(this.player.log("Retrying play with muted audio","info"),this.media.muted=!0,this.media.play().catch(i=>{this.player.handleError(i)}))})}pause(){this.media.pause()}seek(e){this.media.currentTime=e}setVolume(e){this.media.volume=e}setMuted(e){this.media.muted=e}setPlaybackSpeed(e){this.media.playbackRate=e}getQualities(){let e=Array.from(this.media.querySelectorAll("source"));return e.length<=1?[]:e.map((t,i)=>{let s=t.getAttribute("data-quality")||t.getAttribute("label")||"",a=t.getAttribute("data-height")||this.extractHeightFromLabel(s),r=t.getAttribute("data-width")||"";return{index:i,height:a?parseInt(a):0,width:r?parseInt(r):0,src:t.src,type:t.type,name:s||(a?`${a}p`:`Quality ${i+1}`)}}).filter(t=>t.height>0)}extractHeightFromLabel(e){let t=e.match(/(\d+)p/i);return t?parseInt(t[1]):0}switchQuality(e){let t=this.getQualities();if(e<0||e>=t.length){this.player.log("Invalid quality index","warn");return}let i=t[e],s=this.media.currentTime,a=!this.media.paused;if(this.media.currentSrc===i.src){this.player.log("Already at this quality level","info");return}this.player.log(`Switching to quality: ${i.name}`,"info"),this.media.src=i.src;let c=()=>{this.media.removeEventListener("loadedmetadata",c),this.media.currentTime=s,a&&this.media.play().catch(p=>{this.player.log("Failed to resume playback after quality switch","warn")}),this.player.emit("qualitychange",{quality:i.name,index:e})};this.media.addEventListener("loadedmetadata",c),this.media.load()}getCurrentQuality(){let e=this.getQualities(),t=this.media.currentSrc;for(let i=0;i<e.length;i++)if(e[i].src===t)return i;return 0}destroy(){this.media.removeEventListener("loadedmetadata",()=>{}),this.media.removeEventListener("play",()=>{}),this.media.removeEventListener("pause",()=>{})}}});var w=class{constructor(){this.events={}}on(e,t){return this.events[e]||(this.events[e]=[]),this.events[e].push(t),this}once(e,t){let i=(...s)=>{t(...s),this.off(e,i)};return this.on(e,i)}off(e,t){return this.events[e]?(t?this.events[e]=this.events[e].filter(i=>i!==t):delete this.events[e],this):this}emit(e,...t){return this.events[e]?(this.events[e].forEach(i=>{i(...t)}),this):this}removeAllListeners(){return this.events={},this}};var n={createElement(l,e={}){let t=document.createElement(l);return e.className&&(t.className=e.className),e.attributes&&Object.entries(e.attributes).forEach(([i,s])=>{t.setAttribute(i,s)}),e.innerHTML&&(t.innerHTML=e.innerHTML),e.textContent&&(t.textContent=e.textContent),e.style&&Object.assign(t.style,e.style),e.children&&e.children.forEach(i=>{i&&t.appendChild(i)}),t},addClass(l,e){l&&e&&l.classList.add(e)},removeClass(l,e){l&&e&&l.classList.remove(e)},toggleClass(l,e){l&&e&&l.classList.toggle(e)},hasClass(l,e){return l&&l.classList.contains(e)},show(l){l&&(l.style.display="")},hide(l){l&&(l.style.display="none")},fadeIn(l,e=300){if(!l)return;l.style.opacity="0",l.style.display="";let t=null,i=s=>{t||(t=s);let a=s-t,r=Math.min(a/e,1);l.style.opacity=r,a<e&&requestAnimationFrame(i)};requestAnimationFrame(i)},fadeOut(l,e=300){if(!l)return;let t=parseFloat(getComputedStyle(l).opacity)||1,i=null,s=a=>{i||(i=a);let r=a-i,c=Math.max(t-r/e,0);l.style.opacity=c,r<e?requestAnimationFrame(s):l.style.display="none"};requestAnimationFrame(s)},offset(l){if(!l)return{top:0,left:0};let e=l.getBoundingClientRect();return{top:e.top+window.pageYOffset,left:e.left+window.pageXOffset,width:e.width,height:e.height}},escapeHTML(l){let e=document.createElement("div");return e.textContent=l,e.innerHTML},sanitizeHTML(l){let e=document.createElement("div"),t=l.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,"").replace(/<iframe\b[^<]*(?:(?!<\/iframe>)<[^<]*)*<\/iframe>/gi,"").replace(/on\w+\s*=/gi,"").replace(/javascript:/gi,"");return e.innerHTML=t,e.innerHTML}};var m={formatTime(l,e=!1){if(!isFinite(l)||l<0)return e?"00:00:00":"00:00";let t=Math.floor(l/3600),i=Math.floor(l%3600/60),s=Math.floor(l%60),a=r=>String(r).padStart(2,"0");return t>0||e?`${a(t)}:${a(i)}:${a(s)}`:`${a(i)}:${a(s)}`},parseTime(l){let e=l.split(":").map(t=>parseInt(t,10));return e.length===3?e[0]*3600+e[1]*60+e[2]:e.length===2?e[0]*60+e[1]:e.length===1?e[0]:0},formatDuration(l){if(!isFinite(l)||l<0)return"0 seconds";let e=Math.floor(l/3600),t=Math.floor(l%3600/60),i=Math.floor(l%60),s=[];return e>0&&s.push(`${e} hour${e!==1?"s":""}`),t>0&&s.push(`${t} minute${t!==1?"s":""}`),(i>0||s.length===0)&&s.push(`${i} second${i!==1?"s":""}`),s.join(", ")},formatPercentage(l,e){return e===0?0:Math.round(l/e*100)}};var I={play:'<path d="M8 5v14l11-7z"/>',pause:'<path d="M6 4h4v16H6V4zm8 0h4v16h-4V4z"/>',stop:'<rect x="6" y="6" width="12" height="12"/>',rewind:'<path d="M11 18V6l-8.5 6 8.5 6zm.5-6l8.5 6V6l-8.5 6z"/>',forward:'<path d="M4 18l8.5-6L4 6v12zm9-12v12l8.5-6L13 6z"/>',skipPrevious:'<path d="M6 6h2v12H6V6zm3 6l8.5 6V6L9 12z"/>',skipNext:'<path d="M16 6h2v12h-2V6zM6 6l8.5 6L6 18V6z"/>',restart:'<path d="M12 5V1L7 6l5 5V7c3.31 0 6 2.69 6 6s-2.69 6-6 6-6-2.69-6-6H4c0 4.42 3.58 8 8 8s8-3.58 8-8-3.58-8-8-8z"/>',volumeHigh:'<path d="M3 9v6h4l5 5V4L7 9H3zm13.5 3c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02zM14 3.23v2.06c2.89.86 5 3.54 5 6.71s-2.11 5.85-5 6.71v2.06c4.01-.91 7-4.49 7-8.77s-2.99-7.86-7-8.77z"/>',volumeMedium:'<path d="M3 9v6h4l5 5V4L7 9H3zm13.5 3c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02z"/>',volumeLow:'<path d="M7 9v6h4l5 5V4l-5 5H7z"/>',volumeMuted:'<path d="M16.5 12c0-1.77-1.02-3.29-2.5-4.03v2.21l2.45 2.45c.03-.2.05-.41.05-.63zm2.5 0c0 .94-.2 1.82-.54 2.64l1.51 1.51C20.63 14.91 21 13.5 21 12c0-4.28-2.99-7.86-7-8.77v2.06c2.89.86 5 3.54 5 6.71zM4.27 3L3 4.27 7.73 9H3v6h4l5 5v-6.73l4.25 4.25c-.67.52-1.42.93-2.25 1.18v2.06c1.38-.31 2.63-.95 3.69-1.81L19.73 21 21 19.73l-9-9L4.27 3zM12 4L9.91 6.09 12 8.18V4z"/>',fullscreen:'<path d="M7 14H5v5h5v-2H7v-3zm-2-4h2V7h3V5H5v5zm12 7h-3v2h5v-5h-2v3zM14 5v2h3v3h2V5h-5z"/>',fullscreenExit:'<path d="M5 16h3v3h2v-5H5v2zm3-8H5v2h5V5H8v3zm6 11h2v-3h3v-2h-5v5zm2-11V5h-2v5h5V8h-3z"/>',settings:'<path d="M19.14 12.94c.04-.3.06-.61.06-.94 0-.32-.02-.64-.07-.94l2.03-1.58c.18-.14.23-.41.12-.61l-1.92-3.32c-.12-.22-.37-.29-.59-.22l-2.39.96c-.5-.38-1.03-.7-1.62-.94L14.4 2.81c-.04-.24-.24-.41-.48-.41h-3.84c-.24 0-.43.17-.47.41l-.36 2.54c-.59.24-1.13.57-1.62.94l-2.39-.96c-.22-.08-.47 0-.59.22L2.74 8.87c-.12.21-.08.47.12.61l2.03 1.58c-.05.3-.09.63-.09.94s.02.64.07.94l-2.03 1.58c-.18.14-.23.41-.12.61l1.92 3.32c.12.22.37.29.59.22l2.39-.96c.5.38 1.03.7 1.62.94l.36 2.54c.05.24.24.41.48.41h3.84c.24 0 .44-.17.47-.41l.36-2.54c.59-.24 1.13-.56 1.62-.94l2.39.96c.22.08.47 0 .59-.22l1.92-3.32c.12-.22.07-.47-.12-.61l-2.01-1.58zM12 15.6c-1.98 0-3.6-1.62-3.6-3.6s1.62-3.6 3.6-3.6 3.6 1.62 3.6 3.6-1.62 3.6-3.6 3.6z"/>',captions:'<path d="M19 4H5c-1.11 0-2 .9-2 2v12c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm-8 7H9.5v-.5h-2v3h2V13H11v1c0 .55-.45 1-1 1H7c-.55 0-1-.45-1-1v-4c0-.55.45-1 1-1h3c.55 0 1 .45 1 1v1zm7 0h-1.5v-.5h-2v3h2V13H18v1c0 .55-.45 1-1 1h-3c-.55 0-1-.45-1-1v-4c0-.55.45-1 1-1h3c.55 0 1 .45 1 1v1z"/>',captionsOff:'<path d="M19 4H5c-1.11 0-2 .9-2 2v12c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm-8 7H9.5v-.5h-2v3h2V13H11v1c0 .55-.45 1-1 1H7c-.55 0-1-.45-1-1v-4c0-.55.45-1 1-1h3c.55 0 1 .45 1 1v1zm7 0h-1.5v-.5h-2v3h2V13H18v1c0 .55-.45 1-1 1h-3c-.55 0-1-.45-1-1v-4c0-.55.45-1 1-1h3c.55 0 1 .45 1 1v1z"/><path d="M0 0h24v24H0z" fill="none"/>',pip:'<path d="M19 7h-8v6h8V7zm2-4H3c-1.1 0-2 .9-2 2v14c0 1.1.9 1.98 2 1.98h18c1.1 0 2-.88 2-1.98V5c0-1.1-.9-2-2-2zm0 16.01H3V4.98h18v14.03z"/>',speed:'<path d="M20.38 8.57l-1.23 1.85a8 8 0 0 1-.22 7.58H5.07A8 8 0 0 1 15.58 6.85l1.85-1.23A10 10 0 0 0 3.35 19a2 2 0 0 0 1.72 1h13.85a2 2 0 0 0 1.74-1 10 10 0 0 0-.27-10.44z"/><path d="M10.59 15.41a2 2 0 0 0 2.83 0l5.66-8.49-8.49 5.66a2 2 0 0 0 0 2.83z"/>',close:'<path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/>',check:'<path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/>',arrowUp:'<path d="M7 14l5-5 5 5z"/>',arrowDown:'<path d="M7 10l5 5 5-5z"/>',arrowLeft:'<path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"/>',arrowRight:'<path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/>',loading:'<path d="M12 4V1L8 5l4 4V6c3.31 0 6 2.69 6 6 0 1.01-.25 1.97-.7 2.8l1.46 1.46C19.54 15.03 20 13.57 20 12c0-4.42-3.58-8-8-8zm0 14c-3.31 0-6-2.69-6-6 0-1.01.25-1.97.7-2.8L5.24 7.74C4.46 8.97 4 10.43 4 12c0 4.42 3.58 8 8 8v3l4-4-4-4v3z"/>',error:'<path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z"/>',download:'<path d="M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z"/>',link:'<path d="M3.9 12c0-1.71 1.39-3.1 3.1-3.1h4V7H7c-2.76 0-5 2.24-5 5s2.24 5 5 5h4v-1.9H7c-1.71 0-3.1-1.39-3.1-3.1zM8 13h8v-2H8v2zm9-6h-4v1.9h4c1.71 0 3.1 1.39 3.1 3.1s-1.39 3.1-3.1 3.1h-4V17h4c2.76 0 5-2.24 5-5s-2.24-5-5-5z"/>',playlist:'<path d="M15 6H3v2h12V6zm0 4H3v2h12v-2zM3 16h8v-2H3v2zM17 6v8.18c-.31-.11-.65-.18-1-.18-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3V8h3V6h-5z"/>',language:'<path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zm6.93 6h-2.95c-.32-1.25-.78-2.45-1.38-3.56 1.84.63 3.37 1.91 4.33 3.56zM12 4.04c.83 1.2 1.48 2.53 1.91 3.96h-3.82c.43-1.43 1.08-2.76 1.91-3.96zM4.26 14C4.1 13.36 4 12.69 4 12s.1-1.36.26-2h3.38c-.08.66-.14 1.32-.14 2 0 .68.06 1.34.14 2H4.26zm.82 2h2.95c.32 1.25.78 2.45 1.38 3.56-1.84-.63-3.37-1.9-4.33-3.56zm2.95-8H5.08c.96-1.66 2.49-2.93 4.33-3.56C8.81 5.55 8.35 6.75 8.03 8zM12 19.96c-.83-1.2-1.48-2.53-1.91-3.96h3.82c-.43 1.43-1.08 2.76-1.91 3.96zM14.34 14H9.66c-.09-.66-.16-1.32-.16-2 0-.68.07-1.35.16-2h4.68c.09.65.16 1.32.16 2 0 .68-.07 1.34-.16 2zm.25 5.56c.6-1.11 1.06-2.31 1.38-3.56h2.95c-.96 1.65-2.49 2.93-4.33 3.56zM16.36 14c.08-.66.14-1.32.14-2 0-.68-.06-1.34-.14-2h3.38c.16.64.26 1.31.26 2s-.1 1.36-.26 2h-3.38z"/>',hd:'<path d="M19 3H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.11 0 2-.9 2-2V5c0-1.1-.89-2-2-2zm-8 12H9.5v-2h-2v2H6V9h1.5v2.5h2V9H11v6zm7-1c0 .55-.45 1-1 1h-.75v1.5h-1.5V15H14c-.55 0-1-.45-1-1v-4c0-.55.45-1 1-1h3c.55 0 1 .45 1 1v4zm-3.5-.5h2v-3h-2v3z"/>',transcript:'<path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"/>',audioDescription:'<path d="M12 3v9.28c-.47-.17-.97-.28-1.5-.28C8.01 12 6 14.01 6 16.5S8.01 21 10.5 21c2.31 0 4.2-1.75 4.45-4H15V6h4V3h-7z"/><path d="M10.5 19c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/>',audioDescriptionOn:'<path d="M12 3v9.28c-.47-.17-.97-.28-1.5-.28C8.01 12 6 14.01 6 16.5S8.01 21 10.5 21c2.31 0 4.2-1.75 4.45-4H15V6h4V3h-7z"/><path d="M10.5 19c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/><circle cx="19" cy="16" r="3" fill="#3b82f6"/><path d="M18.5 17.5l1-1 1.5 1.5" stroke="white" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/>',signLanguage:'<g transform="scale(1.5)"><path d="M16 11.3c-.1-.9-4.8 1.3-5.4 1.1-2.6-1 5.8-1.3 5.1-2.9s-5.1 1.5-6 1.4C6.5 9.4 16.5 9.1 13.5 8c-1.9-.6-8.8 2.9-6.8.4.7-.6.7-1.9-.7-1.7-9.7 7.2-.7 12.2 8.8 7 0-1.3-3.5.4-4.1.4-2.6 0 5.6-2 5.4-3ZM3.9 7.8c3.2-4.2 3.7 1.2 6 .1s.2-.2.2-.3c.7-2.7 2.5-7.5-1.5-1.3-1.6 0 1.1-4 1-4.6C8.9-1 7.3 4.4 7.2 4.9c-1.6.7-.9-1.4-.7-1.5 3-6-.6-3.1-.9.4-2.5 1.8 0-2.8 0-3.5C2.8-.9 4 9.4 1.1 4.9S.1 4.6 0 5c-.4 2.7 2.6 7.2 3.9 2.8Z"/></g>',signLanguageOn:'<g transform="scale(1.5)"><path d="M16 11.3c-.1-.9-4.8 1.3-5.4 1.1-2.6-1 5.8-1.3 5.1-2.9s-5.1 1.5-6 1.4C6.5 9.4 16.5 9.1 13.5 8c-1.9-.6-8.8 2.9-6.8.4.7-.6.7-1.9-.7-1.7-9.7 7.2-.7 12.2 8.8 7 0-1.3-3.5.4-4.1.4-2.6 0 5.6-2 5.4-3ZM3.9 7.8c3.2-4.2 3.7 1.2 6 .1s.2-.2.2-.3c.7-2.7 2.5-7.5-1.5-1.3-1.6 0 1.1-4 1-4.6C8.9-1 7.3 4.4 7.2 4.9c-1.6.7-.9-1.4-.7-1.5 3-6-.6-3.1-.9.4-2.5 1.8 0-2.8 0-3.5C2.8-.9 4 9.4 1.1 4.9S.1 4.6 0 5c-.4 2.7 2.6 7.2 3.9 2.8Z"/></g><circle cx="19" cy="19" r="3" fill="#3b82f6"/><path d="M17.5 19l1 1 2-2" stroke="white" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/>',speaker:'<path d="M3 9v6h4l5 5V4L7 9H3zm13.5 3c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02z"/>',music:'<path d="M12 3v9.28c-.47-.17-.97-.28-1.5-.28C8.01 12 6 14.01 6 16.5S8.01 21 10.5 21c2.31 0 4.2-1.75 4.45-4H15V6h4V3h-7zm-1.5 16c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/>',moreVertical:'<path d="M12 8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"/>',moreHorizontal:'<path d="M6 10c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm12 0c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm-6 0c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"/>'},R=l=>`<svg viewBox="0 0 24 24" fill="currentColor">${l}</svg>`,B=Object.fromEntries(Object.entries(I).map(([l,e])=>[l,R(e)]));function W(l){return B[l]||B.play}function h(l,e=""){let t=document.createElement("span");return t.className=`vidply-icon ${e}`.trim(),t.innerHTML=W(l),t.setAttribute("aria-hidden","true"),t}function H(){let l=document.createElementNS("http://www.w3.org/2000/svg","svg");l.setAttribute("class","vidply-play-overlay"),l.setAttribute("viewBox","0 0 80 80"),l.setAttribute("width","80"),l.setAttribute("height","80"),l.setAttribute("aria-hidden","true"),l.setAttribute("role","presentation"),l.style.cursor="pointer";let e=document.createElementNS("http://www.w3.org/2000/svg","defs"),t=`vidply-play-shadow-${Math.random().toString(36).substr(2,9)}`,i=document.createElementNS("http://www.w3.org/2000/svg","filter");i.setAttribute("id",t),i.setAttribute("x","-50%"),i.setAttribute("y","-50%"),i.setAttribute("width","200%"),i.setAttribute("height","200%");let s=document.createElementNS("http://www.w3.org/2000/svg","feGaussianBlur");s.setAttribute("in","SourceAlpha"),s.setAttribute("stdDeviation","3");let a=document.createElementNS("http://www.w3.org/2000/svg","feOffset");a.setAttribute("dx","0"),a.setAttribute("dy","2"),a.setAttribute("result","offsetblur");let r=document.createElementNS("http://www.w3.org/2000/svg","feComponentTransfer"),c=document.createElementNS("http://www.w3.org/2000/svg","feFuncA");c.setAttribute("type","linear"),c.setAttribute("slope","0.3"),r.appendChild(c);let p=document.createElementNS("http://www.w3.org/2000/svg","feMerge"),d=document.createElementNS("http://www.w3.org/2000/svg","feMergeNode"),u=document.createElementNS("http://www.w3.org/2000/svg","feMergeNode");u.setAttribute("in","SourceGraphic"),p.appendChild(d),p.appendChild(u),i.appendChild(s),i.appendChild(a),i.appendChild(r),i.appendChild(p),e.appendChild(i),l.appendChild(e);let y=document.createElementNS("http://www.w3.org/2000/svg","circle");y.setAttribute("cx","40"),y.setAttribute("cy","40"),y.setAttribute("r","40"),y.setAttribute("fill","rgba(255, 255, 255, 0.95)"),y.setAttribute("filter",`url(#${t})`),y.setAttribute("class","vidply-play-overlay-bg"),l.appendChild(y);let b=document.createElementNS("http://www.w3.org/2000/svg","polygon");return b.setAttribute("points","32,28 32,52 54,40"),b.setAttribute("fill","#0a406e"),b.setAttribute("class","vidply-play-overlay-icon"),l.appendChild(b),l}var V={en:{player:{label:"Video Player",play:"Play",pause:"Pause",stop:"Stop",restart:"Restart from beginning",rewind:"Rewind",forward:"Forward",rewindSeconds:"Rewind {seconds} seconds",forwardSeconds:"Forward {seconds} seconds",previous:"Previous track",next:"Next track",volume:"Volume",mute:"Mute",unmute:"Unmute",fullscreen:"Fullscreen",exitFullscreen:"Exit Fullscreen",captions:"Captions",chapters:"Chapters",quality:"Quality",captionStyling:"Caption styling",transcript:"Toggle transcript",audioDescription:"Audio description",signLanguage:"Sign language video",settings:"Settings",speed:"Playback Speed",pip:"Picture in Picture",currentTime:"Current time",duration:"Duration",progress:"Progress",seekForward:"Seek forward {seconds} seconds",seekBackward:"Seek backward {seconds} seconds",volumeUp:"Volume up",volumeDown:"Volume down",loading:"Loading...",loadingChapters:"Loading chapters...",error:"Error loading media",buffering:"Buffering...",signLanguageVideo:"Sign Language Video",noChapters:"No chapters available",noCaptions:"No captions available",auto:"Auto",autoQuality:"Auto (no quality selection available)",noQuality:"Quality selection not available"},captions:{off:"Off",select:"Select captions",fontSize:"Font Size",fontFamily:"Font Family",color:"Text Color",backgroundColor:"Background Color",opacity:"Opacity"},fontSizes:{small:"Small",medium:"Medium",large:"Large",xlarge:"X-Large"},fontFamilies:{sansSerif:"Sans-serif",serif:"Serif",monospace:"Monospace"},styleLabels:{textColor:"Text Color",background:"Background",font:"Font",fontSize:"Font Size",opacity:"Opacity"},audioDescription:{enable:"Enable audio description",disable:"Disable audio description"},signLanguage:{show:"Show sign language video",hide:"Hide sign language video"},transcript:{title:"Transcript",close:"Close transcript",loading:"Loading transcript...",noTranscript:"No transcript available for this video."},settings:{title:"Settings",quality:"Quality",speed:"Speed",captions:"Captions",language:"Language",reset:"Reset to defaults",close:"Close"},speeds:{normal:"Normal"}},de:{player:{label:"Videoplayer",play:"Abspielen",pause:"Pause",stop:"Stopp",restart:"Von vorne beginnen",rewind:"Zur\xFCckspulen",forward:"Vorspulen",rewindSeconds:"{seconds} Sekunden zur\xFCckspulen",forwardSeconds:"{seconds} Sekunden vorspulen",previous:"Vorheriger Titel",next:"N\xE4chster Titel",volume:"Lautst\xE4rke",mute:"Stumm",unmute:"Ton ein",fullscreen:"Vollbild",exitFullscreen:"Vollbild beenden",captions:"Untertitel",chapters:"Kapitel",quality:"Qualit\xE4t",captionStyling:"Untertitel-Stil",transcript:"Transkript umschalten",audioDescription:"Audiodeskription",signLanguage:"Geb\xE4rdensprache-Video",settings:"Einstellungen",speed:"Wiedergabegeschwindigkeit",pip:"Bild-in-Bild",currentTime:"Aktuelle Zeit",duration:"Dauer",progress:"Fortschritt",seekForward:"{seconds} Sekunden vorspulen",seekBackward:"{seconds} Sekunden zur\xFCckspulen",volumeUp:"Lauter",volumeDown:"Leiser",loading:"L\xE4dt...",loadingChapters:"Kapitel werden geladen...",error:"Fehler beim Laden",buffering:"Puffern...",signLanguageVideo:"Geb\xE4rdensprache-Video",noChapters:"Keine Kapitel verf\xFCgbar",noCaptions:"Keine Untertitel verf\xFCgbar",auto:"Automatisch",autoQuality:"Automatisch (keine Qualit\xE4tsauswahl verf\xFCgbar)",noQuality:"Qualit\xE4tsauswahl nicht verf\xFCgbar"},captions:{off:"Aus",select:"Untertitel ausw\xE4hlen",fontSize:"Schriftgr\xF6\xDFe",fontFamily:"Schriftart",color:"Textfarbe",backgroundColor:"Hintergrundfarbe",opacity:"Deckkraft"},fontSizes:{small:"Klein",medium:"Mittel",large:"Gro\xDF",xlarge:"Sehr gro\xDF"},fontFamilies:{sansSerif:"Sans-serif",serif:"Serif",monospace:"Monospace"},styleLabels:{textColor:"Textfarbe",background:"Hintergrund",font:"Schrift",fontSize:"Schriftgr\xF6\xDFe",opacity:"Deckkraft"},audioDescription:{enable:"Audiodeskription aktivieren",disable:"Audiodeskription deaktivieren"},signLanguage:{show:"Geb\xE4rdensprache-Video anzeigen",hide:"Geb\xE4rdensprache-Video ausblenden"},transcript:{title:"Transkript",close:"Transkript schlie\xDFen",loading:"Transkript wird geladen...",noTranscript:"Kein Transkript f\xFCr dieses Video verf\xFCgbar."},settings:{title:"Einstellungen",quality:"Qualit\xE4t",speed:"Geschwindigkeit",captions:"Untertitel",language:"Sprache",reset:"Zur\xFCcksetzen",close:"Schlie\xDFen"},speeds:{normal:"Normal"}},es:{player:{label:"Reproductor de video",play:"Reproducir",pause:"Pausa",stop:"Detener",restart:"Reiniciar desde el principio",rewind:"Retroceder",forward:"Avanzar",rewindSeconds:"Retroceder {seconds} segundos",forwardSeconds:"Avanzar {seconds} segundos",previous:"Pista anterior",next:"Siguiente pista",volume:"Volumen",mute:"Silenciar",unmute:"Activar sonido",fullscreen:"Pantalla completa",exitFullscreen:"Salir de pantalla completa",captions:"Subt\xEDtulos",chapters:"Cap\xEDtulos",quality:"Calidad",captionStyling:"Estilo de subt\xEDtulos",transcript:"Alternar transcripci\xF3n",audioDescription:"Audiodescripci\xF3n",signLanguage:"Video en lengua de se\xF1as",settings:"Configuraci\xF3n",speed:"Velocidad de reproducci\xF3n",pip:"Imagen en imagen",currentTime:"Tiempo actual",duration:"Duraci\xF3n",progress:"Progreso",seekForward:"Avanzar {seconds} segundos",seekBackward:"Retroceder {seconds} segundos",volumeUp:"Subir volumen",volumeDown:"Bajar volumen",loading:"Cargando...",loadingChapters:"Cargando cap\xEDtulos...",error:"Error al cargar",buffering:"Almacenando en b\xFAfer...",signLanguageVideo:"Video en Lengua de Se\xF1as",noChapters:"No hay cap\xEDtulos disponibles",noCaptions:"No hay subt\xEDtulos disponibles",auto:"Autom\xE1tico",autoQuality:"Autom\xE1tico (selecci\xF3n de calidad no disponible)",noQuality:"Selecci\xF3n de calidad no disponible"},captions:{off:"Desactivado",select:"Seleccionar subt\xEDtulos",fontSize:"Tama\xF1o de fuente",fontFamily:"Familia de fuente",color:"Color de texto",backgroundColor:"Color de fondo",opacity:"Opacidad"},fontSizes:{small:"Peque\xF1o",medium:"Mediano",large:"Grande",xlarge:"Muy grande"},fontFamilies:{sansSerif:"Sans-serif",serif:"Serif",monospace:"Monospace"},styleLabels:{textColor:"Color de texto",background:"Fondo",font:"Fuente",fontSize:"Tama\xF1o de fuente",opacity:"Opacidad"},audioDescription:{enable:"Activar audiodescripci\xF3n",disable:"Desactivar audiodescripci\xF3n"},signLanguage:{show:"Mostrar video en lengua de se\xF1as",hide:"Ocultar video en lengua de se\xF1as"},transcript:{title:"Transcripci\xF3n",close:"Cerrar transcripci\xF3n",loading:"Cargando transcripci\xF3n...",noTranscript:"No hay transcripci\xF3n disponible para este video."},settings:{title:"Configuraci\xF3n",quality:"Calidad",speed:"Velocidad",captions:"Subt\xEDtulos",language:"Idioma",reset:"Restablecer",close:"Cerrar"},speeds:{normal:"Normal"}},fr:{player:{label:"Lecteur vid\xE9o",play:"Lecture",pause:"Pause",stop:"Arr\xEAt",restart:"Red\xE9marrer du d\xE9but",rewind:"Reculer",forward:"Avancer",rewindSeconds:"Reculer de {seconds} secondes",forwardSeconds:"Avancer de {seconds} secondes",previous:"Piste pr\xE9c\xE9dente",next:"Piste suivante",volume:"Volume",mute:"Muet",unmute:"Activer le son",fullscreen:"Plein \xE9cran",exitFullscreen:"Quitter le plein \xE9cran",captions:"Sous-titres",chapters:"Chapitres",quality:"Qualit\xE9",captionStyling:"Style des sous-titres",transcript:"Activer/d\xE9sactiver la transcription",audioDescription:"Audiodescription",signLanguage:"Vid\xE9o en langue des signes",settings:"Param\xE8tres",speed:"Vitesse de lecture",pip:"Image dans l'image",currentTime:"Temps actuel",duration:"Dur\xE9e",progress:"Progression",seekForward:"Avancer de {seconds} secondes",seekBackward:"Reculer de {seconds} secondes",volumeUp:"Augmenter le volume",volumeDown:"Diminuer le volume",loading:"Chargement...",loadingChapters:"Chargement des chapitres...",error:"Erreur de chargement",buffering:"Mise en m\xE9moire tampon...",signLanguageVideo:"Vid\xE9o en Langue des Signes",noChapters:"Aucun chapitre disponible",noCaptions:"Aucun sous-titre disponible",auto:"Automatique",autoQuality:"Automatique (s\xE9lection de qualit\xE9 non disponible)",noQuality:"S\xE9lection de qualit\xE9 non disponible"},captions:{off:"D\xE9sactiv\xE9",select:"S\xE9lectionner les sous-titres",fontSize:"Taille de police",fontFamily:"Police",color:"Couleur du texte",backgroundColor:"Couleur de fond",opacity:"Opacit\xE9"},fontSizes:{small:"Petit",medium:"Moyen",large:"Grand",xlarge:"Tr\xE8s grand"},fontFamilies:{sansSerif:"Sans-serif",serif:"Serif",monospace:"Monospace"},styleLabels:{textColor:"Couleur du texte",background:"Arri\xE8re-plan",font:"Police",fontSize:"Taille de police",opacity:"Opacit\xE9"},audioDescription:{enable:"Activer l'audiodescription",disable:"D\xE9sactiver l'audiodescription"},signLanguage:{show:"Afficher la vid\xE9o en langue des signes",hide:"Masquer la vid\xE9o en langue des signes"},transcript:{title:"Transcription",close:"Fermer la transcription",loading:"Chargement de la transcription...",noTranscript:"Aucune transcription disponible pour cette vid\xE9o."},settings:{title:"Param\xE8tres",quality:"Qualit\xE9",speed:"Vitesse",captions:"Sous-titres",language:"Langue",reset:"R\xE9initialiser",close:"Fermer"},speeds:{normal:"Normal"}},ja:{player:{label:"\u30D3\u30C7\u30AA\u30D7\u30EC\u30FC\u30E4\u30FC",play:"\u518D\u751F",pause:"\u4E00\u6642\u505C\u6B62",stop:"\u505C\u6B62",restart:"\u6700\u521D\u304B\u3089\u518D\u751F",rewind:"\u5DFB\u304D\u623B\u3057",forward:"\u65E9\u9001\u308A",rewindSeconds:"{seconds}\u79D2\u623B\u3059",forwardSeconds:"{seconds}\u79D2\u9032\u3081\u308B",previous:"\u524D\u306E\u30C8\u30E9\u30C3\u30AF",next:"\u6B21\u306E\u30C8\u30E9\u30C3\u30AF",volume:"\u97F3\u91CF",mute:"\u30DF\u30E5\u30FC\u30C8",unmute:"\u30DF\u30E5\u30FC\u30C8\u89E3\u9664",fullscreen:"\u5168\u753B\u9762\u8868\u793A",exitFullscreen:"\u5168\u753B\u9762\u8868\u793A\u3092\u7D42\u4E86",captions:"\u5B57\u5E55",chapters:"\u30C1\u30E3\u30D7\u30BF\u30FC",quality:"\u753B\u8CEA",captionStyling:"\u5B57\u5E55\u30B9\u30BF\u30A4\u30EB",transcript:"\u6587\u5B57\u8D77\u3053\u3057\u5207\u308A\u66FF\u3048",audioDescription:"\u97F3\u58F0\u89E3\u8AAC",signLanguage:"\u624B\u8A71\u52D5\u753B",settings:"\u8A2D\u5B9A",speed:"\u518D\u751F\u901F\u5EA6",pip:"\u30D4\u30AF\u30C1\u30E3\u30FC\u30A4\u30F3\u30D4\u30AF\u30C1\u30E3\u30FC",currentTime:"\u73FE\u5728\u306E\u6642\u9593",duration:"\u518D\u751F\u6642\u9593",progress:"\u9032\u884C\u72B6\u6CC1",seekForward:"{seconds}\u79D2\u9032\u3081\u308B",seekBackward:"{seconds}\u79D2\u623B\u3059",volumeUp:"\u97F3\u91CF\u3092\u4E0A\u3052\u308B",volumeDown:"\u97F3\u91CF\u3092\u4E0B\u3052\u308B",loading:"\u8AAD\u307F\u8FBC\u307F\u4E2D...",loadingChapters:"\u30C1\u30E3\u30D7\u30BF\u30FC\u8AAD\u307F\u8FBC\u307F\u4E2D...",error:"\u8AAD\u307F\u8FBC\u307F\u30A8\u30E9\u30FC",buffering:"\u30D0\u30C3\u30D5\u30A1\u30EA\u30F3\u30B0\u4E2D...",signLanguageVideo:"\u624B\u8A71\u52D5\u753B",noChapters:"\u30C1\u30E3\u30D7\u30BF\u30FC\u304C\u3042\u308A\u307E\u305B\u3093",noCaptions:"\u5B57\u5E55\u304C\u3042\u308A\u307E\u305B\u3093",auto:"\u81EA\u52D5",autoQuality:"\u81EA\u52D5\uFF08\u753B\u8CEA\u9078\u629E\u4E0D\u53EF\uFF09",noQuality:"\u753B\u8CEA\u9078\u629E\u4E0D\u53EF"},captions:{off:"\u30AA\u30D5",select:"\u5B57\u5E55\u3092\u9078\u629E",fontSize:"\u30D5\u30A9\u30F3\u30C8\u30B5\u30A4\u30BA",fontFamily:"\u30D5\u30A9\u30F3\u30C8",color:"\u30C6\u30AD\u30B9\u30C8\u306E\u8272",backgroundColor:"\u80CC\u666F\u8272",opacity:"\u4E0D\u900F\u660E\u5EA6"},fontSizes:{small:"\u5C0F",medium:"\u4E2D",large:"\u5927",xlarge:"\u7279\u5927"},fontFamilies:{sansSerif:"\u30B5\u30F3\u30BB\u30EA\u30D5",serif:"\u30BB\u30EA\u30D5",monospace:"\u7B49\u5E45"},styleLabels:{textColor:"\u30C6\u30AD\u30B9\u30C8\u306E\u8272",background:"\u80CC\u666F",font:"\u30D5\u30A9\u30F3\u30C8",fontSize:"\u30D5\u30A9\u30F3\u30C8\u30B5\u30A4\u30BA",opacity:"\u4E0D\u900F\u660E\u5EA6"},audioDescription:{enable:"\u97F3\u58F0\u89E3\u8AAC\u3092\u6709\u52B9\u306B\u3059\u308B",disable:"\u97F3\u58F0\u89E3\u8AAC\u3092\u7121\u52B9\u306B\u3059\u308B"},signLanguage:{show:"\u624B\u8A71\u52D5\u753B\u3092\u8868\u793A",hide:"\u624B\u8A71\u52D5\u753B\u3092\u975E\u8868\u793A"},transcript:{title:"\u6587\u5B57\u8D77\u3053\u3057",close:"\u6587\u5B57\u8D77\u3053\u3057\u3092\u9589\u3058\u308B",loading:"\u6587\u5B57\u8D77\u3053\u3057\u3092\u8AAD\u307F\u8FBC\u307F\u4E2D...",noTranscript:"\u3053\u306E\u30D3\u30C7\u30AA\u306E\u6587\u5B57\u8D77\u3053\u3057\u306F\u3042\u308A\u307E\u305B\u3093\u3002"},settings:{title:"\u8A2D\u5B9A",quality:"\u753B\u8CEA",speed:"\u901F\u5EA6",captions:"\u5B57\u5E55",language:"\u8A00\u8A9E",reset:"\u30EA\u30BB\u30C3\u30C8",close:"\u9589\u3058\u308B"},speeds:{normal:"\u901A\u5E38"}}};var T=class{constructor(){this.currentLanguage="en",this.translations=V}setLanguage(e){this.translations[e]?this.currentLanguage=e:(console.warn(`Language "${e}" not found, falling back to English`),this.currentLanguage="en")}getLanguage(){return this.currentLanguage}t(e,t={}){let i=e.split("."),s=this.translations[this.currentLanguage];for(let a of i)if(s&&typeof s=="object"&&a in s)s=s[a];else{s=this.translations.en;for(let r of i)if(s&&typeof s=="object"&&r in s)s=s[r];else return e;break}return typeof s=="string"&&Object.entries(t).forEach(([a,r])=>{s=s.replace(new RegExp(`{${a}}`,"g"),r)}),s}addTranslation(e,t){this.translations[e]||(this.translations[e]={}),Object.assign(this.translations[e],t)}},o=new T;var C=class{constructor(e){this.player=e,this.element=null,this.controls={},this.hideTimeout=null,this.isDraggingProgress=!1,this.isDraggingVolume=!1,this.init()}init(){this.createElement(),this.createControls(),this.attachEvents(),this.setupAutoHide()}isMobile(){return window.innerWidth<640}positionMenu(e,t){this.isMobile()||setTimeout(()=>{let s=t.getBoundingClientRect(),a=e.getBoundingClientRect(),r=window.innerWidth,c=window.innerHeight,p=s.top,d=c-s.bottom;p<a.height+20&&d>p&&(e.style.bottom="auto",e.style.top="calc(100% + 8px)",e.classList.add("vidply-menu-below"));let u=s.left+s.width/2-a.width/2;u<10?(e.style.right="auto",e.style.left="0",e.style.transform="translateX(0)"):u+a.width>r-10&&(e.style.left="auto",e.style.right="0",e.style.transform="translateX(0)")},0)}attachMenuCloseHandler(e,t,i=!1){this.positionMenu(e,t),setTimeout(()=>{let s=r=>{i&&e.contains(r.target)||!e.contains(r.target)&&!t.contains(r.target)&&(e.remove(),document.removeEventListener("click",s),document.removeEventListener("keydown",a))},a=r=>{r.key==="Escape"&&(e.remove(),document.removeEventListener("click",s),document.removeEventListener("keydown",a),t.focus())};document.addEventListener("click",s),document.addEventListener("keydown",a)},100)}createElement(){this.element=n.createElement("div",{className:`${this.player.options.classPrefix}-controls`,attributes:{role:"region","aria-label":o.t("player.label")+" controls"}})}createControls(){this.player.options.progressBar&&this.createProgressBar();let e=n.createElement("div",{className:`${this.player.options.classPrefix}-controls-buttons`}),t=n.createElement("div",{className:`${this.player.options.classPrefix}-controls-left`});this.player.playlistManager&&t.appendChild(this.createPreviousButton()),this.player.options.playPauseButton&&t.appendChild(this.createPlayPauseButton()),t.appendChild(this.createRestartButton()),this.player.playlistManager&&t.appendChild(this.createNextButton()),this.player.playlistManager||t.appendChild(this.createRewindButton()),this.player.playlistManager||t.appendChild(this.createForwardButton()),this.player.options.volumeControl&&t.appendChild(this.createVolumeControl()),(this.player.options.currentTime||this.player.options.duration)&&t.appendChild(this.createTimeDisplay()),this.rightButtons=n.createElement("div",{className:`${this.player.options.classPrefix}-controls-right`});let i=this.hasChapterTracks(),s=this.hasCaptionTracks(),a=this.hasQualityLevels(),r=this.hasAudioDescription();this.player.options.chaptersButton&&i&&this.rightButtons.appendChild(this.createChaptersButton()),this.player.options.qualityButton&&a&&this.rightButtons.appendChild(this.createQualityButton()),this.player.options.captionStyleButton&&s&&this.rightButtons.appendChild(this.createCaptionStyleButton()),this.player.options.speedButton&&this.rightButtons.appendChild(this.createSpeedButton()),this.player.options.captionsButton&&s&&this.rightButtons.appendChild(this.createCaptionsButton()),this.player.options.transcriptButton&&s&&this.rightButtons.appendChild(this.createTranscriptButton()),this.player.options.audioDescriptionButton&&r&&this.rightButtons.appendChild(this.createAudioDescriptionButton());let c=this.hasSignLanguage();this.player.options.signLanguageButton&&c&&this.rightButtons.appendChild(this.createSignLanguageButton()),this.player.options.pipButton&&"pictureInPictureEnabled"in document&&this.rightButtons.appendChild(this.createPipButton()),this.player.options.fullscreenButton&&this.rightButtons.appendChild(this.createFullscreenButton()),e.appendChild(t),e.appendChild(this.rightButtons),this.element.appendChild(e)}hasChapterTracks(){let e=this.player.element.textTracks;for(let t=0;t<e.length;t++)if(e[t].kind==="chapters")return!0;return!1}hasCaptionTracks(){let e=this.player.element.textTracks;for(let t=0;t<e.length;t++)if(e[t].kind==="captions"||e[t].kind==="subtitles")return!0;return!1}hasQualityLevels(){if(this.player.renderer&&this.player.renderer.getQualities){let e=this.player.renderer.getQualities();return e&&e.length>1}return!1}hasAudioDescription(){return this.player.audioDescriptionSrc&&this.player.audioDescriptionSrc.length>0}hasSignLanguage(){return this.player.signLanguageSrc&&this.player.signLanguageSrc.length>0}createProgressBar(){let e=n.createElement("div",{className:`${this.player.options.classPrefix}-progress-container`,attributes:{role:"slider","aria-label":o.t("player.progress"),"aria-valuemin":"0","aria-valuemax":"100","aria-valuenow":"0",tabindex:"0"}});this.controls.buffered=n.createElement("div",{className:`${this.player.options.classPrefix}-progress-buffered`}),this.controls.played=n.createElement("div",{className:`${this.player.options.classPrefix}-progress-played`}),this.controls.progressHandle=n.createElement("div",{className:`${this.player.options.classPrefix}-progress-handle`}),this.controls.progressTooltip=n.createElement("div",{className:`${this.player.options.classPrefix}-progress-tooltip`}),e.appendChild(this.controls.buffered),e.appendChild(this.controls.played),this.controls.played.appendChild(this.controls.progressHandle),e.appendChild(this.controls.progressTooltip),this.controls.progress=e,this.element.appendChild(e),this.setupProgressBarEvents()}setupProgressBarEvents(){let e=this.controls.progress,t=i=>{let s=e.getBoundingClientRect(),a=Math.max(0,Math.min(1,(i-s.left)/s.width)),r=a*this.player.state.duration;return{percent:a,time:r}};e.addEventListener("mousedown",i=>{this.isDraggingProgress=!0;let{time:s}=t(i.clientX);this.player.seek(s)}),document.addEventListener("mousemove",i=>{if(this.isDraggingProgress){let{time:s}=t(i.clientX);this.player.seek(s)}}),document.addEventListener("mouseup",()=>{this.isDraggingProgress=!1}),e.addEventListener("mousemove",i=>{if(!this.isDraggingProgress){let{time:s}=t(i.clientX);this.controls.progressTooltip.textContent=m.formatTime(s),this.controls.progressTooltip.style.left=`${i.clientX-e.getBoundingClientRect().left}px`,this.controls.progressTooltip.style.display="block"}}),e.addEventListener("mouseleave",()=>{this.controls.progressTooltip.style.display="none"}),e.addEventListener("keydown",i=>{i.key==="ArrowLeft"?(i.preventDefault(),this.player.seekBackward(5)):i.key==="ArrowRight"&&(i.preventDefault(),this.player.seekForward(5))}),e.addEventListener("touchstart",i=>{this.isDraggingProgress=!0;let s=i.touches[0],{time:a}=t(s.clientX);this.player.seek(a)}),e.addEventListener("touchmove",i=>{if(this.isDraggingProgress){i.preventDefault();let s=i.touches[0],{time:a}=t(s.clientX);this.player.seek(a)}}),e.addEventListener("touchend",()=>{this.isDraggingProgress=!1})}createPlayPauseButton(){let e=n.createElement("button",{className:`${this.player.options.classPrefix}-button ${this.player.options.classPrefix}-play-pause`,attributes:{type:"button","aria-label":o.t("player.play")}});return e.appendChild(h("play")),e.addEventListener("click",()=>{this.player.toggle()}),this.controls.playPause=e,e}createRestartButton(){let e=n.createElement("button",{className:`${this.player.options.classPrefix}-button ${this.player.options.classPrefix}-restart`,attributes:{type:"button","aria-label":o.t("player.restart")}});return e.appendChild(h("restart")),e.addEventListener("click",()=>{this.player.seek(0),this.player.play()}),e}createPreviousButton(){let e=n.createElement("button",{className:`${this.player.options.classPrefix}-button ${this.player.options.classPrefix}-previous`,attributes:{type:"button","aria-label":o.t("player.previous")}});e.appendChild(h("skipPrevious")),e.addEventListener("click",()=>{this.player.playlistManager&&this.player.playlistManager.previous()});let t=()=>{this.player.playlistManager&&(e.disabled=!this.player.playlistManager.hasPrevious()&&!this.player.playlistManager.options.loop)};return this.player.on("playlisttrackchange",t),t(),this.controls.previous=e,e}createNextButton(){let e=n.createElement("button",{className:`${this.player.options.classPrefix}-button ${this.player.options.classPrefix}-next`,attributes:{type:"button","aria-label":o.t("player.next")}});e.appendChild(h("skipNext")),e.addEventListener("click",()=>{this.player.playlistManager&&this.player.playlistManager.next()});let t=()=>{this.player.playlistManager&&(e.disabled=!this.player.playlistManager.hasNext()&&!this.player.playlistManager.options.loop)};return this.player.on("playlisttrackchange",t),t(),this.controls.next=e,e}createRewindButton(){let e=n.createElement("button",{className:`${this.player.options.classPrefix}-button ${this.player.options.classPrefix}-rewind`,attributes:{type:"button","aria-label":o.t("player.rewindSeconds",{seconds:15})}});return e.appendChild(h("rewind")),e.addEventListener("click",()=>{this.player.seekBackward(15)}),e}createForwardButton(){let e=n.createElement("button",{className:`${this.player.options.classPrefix}-button ${this.player.options.classPrefix}-forward`,attributes:{type:"button","aria-label":o.t("player.forwardSeconds",{seconds:15})}});return e.appendChild(h("forward")),e.addEventListener("click",()=>{this.player.seekForward(15)}),e}createVolumeControl(){let e=n.createElement("button",{className:`${this.player.options.classPrefix}-button ${this.player.options.classPrefix}-mute`,attributes:{type:"button","aria-label":o.t("player.volume"),"aria-haspopup":"true"}});return e.appendChild(h("volumeHigh")),e.addEventListener("contextmenu",t=>{t.preventDefault(),this.player.toggleMute()}),e.addEventListener("click",()=>{this.showVolumeSlider(e)}),this.controls.mute=e,e}showVolumeSlider(e){let t=document.querySelector(`.${this.player.options.classPrefix}-volume-menu`);if(t){t.remove();return}let i=n.createElement("div",{className:`${this.player.options.classPrefix}-volume-menu ${this.player.options.classPrefix}-menu`}),s=n.createElement("div",{className:`${this.player.options.classPrefix}-volume-slider`,attributes:{role:"slider","aria-label":o.t("player.volume"),"aria-valuemin":"0","aria-valuemax":"100","aria-valuenow":String(Math.round(this.player.state.volume*100)),tabindex:"0"}}),a=n.createElement("div",{className:`${this.player.options.classPrefix}-volume-track`}),r=n.createElement("div",{className:`${this.player.options.classPrefix}-volume-fill`}),c=n.createElement("div",{className:`${this.player.options.classPrefix}-volume-handle`});a.appendChild(r),r.appendChild(c),s.appendChild(a),i.appendChild(s);let p=d=>{let u=a.getBoundingClientRect(),y=Math.max(0,Math.min(1,1-(d-u.top)/u.height));this.player.setVolume(y)};s.addEventListener("mousedown",d=>{d.stopPropagation(),this.isDraggingVolume=!0,p(d.clientY)}),document.addEventListener("mousemove",d=>{this.isDraggingVolume&&p(d.clientY)}),document.addEventListener("mouseup",()=>{this.isDraggingVolume=!1}),s.addEventListener("keydown",d=>{d.key==="ArrowUp"?(d.preventDefault(),this.player.setVolume(Math.min(1,this.player.state.volume+.1))):d.key==="ArrowDown"&&(d.preventDefault(),this.player.setVolume(Math.max(0,this.player.state.volume-.1)))}),i.addEventListener("click",d=>{d.stopPropagation()}),e.appendChild(i),this.controls.volumeSlider=s,this.controls.volumeFill=r,this.attachMenuCloseHandler(i,e,!0)}createTimeDisplay(){let e=n.createElement("div",{className:`${this.player.options.classPrefix}-time`});this.controls.currentTimeDisplay=n.createElement("span",{className:`${this.player.options.classPrefix}-current-time`,textContent:"00:00"});let t=n.createElement("span",{textContent:" / ",attributes:{"aria-hidden":"true"}});return this.controls.durationDisplay=n.createElement("span",{className:`${this.player.options.classPrefix}-duration`,textContent:"00:00"}),e.appendChild(this.controls.currentTimeDisplay),e.appendChild(t),e.appendChild(this.controls.durationDisplay),e}createChaptersButton(){let e=n.createElement("button",{className:`${this.player.options.classPrefix}-button ${this.player.options.classPrefix}-chapters`,attributes:{type:"button","aria-label":o.t("player.chapters"),"aria-haspopup":"menu"}});return e.appendChild(h("playlist")),e.addEventListener("click",()=>{this.showChaptersMenu(e)}),this.controls.chapters=e,e}showChaptersMenu(e){let t=document.querySelector(`.${this.player.options.classPrefix}-chapters-menu`);if(t){t.remove();return}let i=n.createElement("div",{className:`${this.player.options.classPrefix}-chapters-menu ${this.player.options.classPrefix}-menu`,attributes:{role:"menu","aria-label":o.t("player.chapters")}}),s=Array.from(this.player.element.textTracks).filter(a=>a.kind==="chapters");if(s.length===0){let a=n.createElement("div",{className:`${this.player.options.classPrefix}-menu-item`,textContent:o.t("player.noChapters"),style:{opacity:"0.5",cursor:"default"}});i.appendChild(a)}else{let a=s[0];if(a.mode==="disabled"&&(a.mode="hidden"),!a.cues||a.cues.length===0){let r=n.createElement("div",{className:`${this.player.options.classPrefix}-menu-item`,textContent:o.t("player.loadingChapters"),style:{opacity:"0.5",cursor:"default"}});i.appendChild(r);let c=()=>{i.remove(),this.showChaptersMenu(e)};a.addEventListener("load",c,{once:!0}),setTimeout(()=>{a.cues&&a.cues.length>0&&document.contains(i)&&(i.remove(),this.showChaptersMenu(e))},500)}else{let r=a.cues;for(let c=0;c<r.length;c++){let p=r[c],d=n.createElement("button",{className:`${this.player.options.classPrefix}-menu-item`,attributes:{type:"button",role:"menuitem"}}),u=n.createElement("span",{className:`${this.player.options.classPrefix}-chapter-time`,textContent:m.formatTime(p.startTime)}),y=n.createElement("span",{className:`${this.player.options.classPrefix}-chapter-title`,textContent:p.text});d.appendChild(u),d.appendChild(document.createTextNode(" ")),d.appendChild(y),d.addEventListener("click",()=>{this.player.seek(p.startTime),i.remove()}),i.appendChild(d)}}}e.appendChild(i),this.attachMenuCloseHandler(i,e)}createQualityButton(){let e=n.createElement("button",{className:`${this.player.options.classPrefix}-button ${this.player.options.classPrefix}-quality`,attributes:{type:"button","aria-label":o.t("player.quality"),"aria-haspopup":"menu"}});e.appendChild(h("hd"));let t=n.createElement("span",{className:`${this.player.options.classPrefix}-quality-text`,textContent:""});return e.appendChild(t),e.addEventListener("click",()=>{this.showQualityMenu(e)}),this.controls.quality=e,this.controls.qualityText=t,setTimeout(()=>this.updateQualityIndicator(),500),e}showQualityMenu(e){let t=document.querySelector(`.${this.player.options.classPrefix}-quality-menu`);if(t){t.remove();return}let i=n.createElement("div",{className:`${this.player.options.classPrefix}-quality-menu ${this.player.options.classPrefix}-menu`,attributes:{role:"menu","aria-label":o.t("player.quality")}});if(this.player.renderer&&this.player.renderer.getQualities){let s=this.player.renderer.getQualities(),a=this.player.renderer.getCurrentQuality?this.player.renderer.getCurrentQuality():-1,r=this.player.renderer.hls!==void 0;if(s.length===0){let c=n.createElement("div",{className:`${this.player.options.classPrefix}-menu-item`,textContent:o.t("player.autoQuality"),style:{opacity:"0.5",cursor:"default"}});i.appendChild(c)}else{if(r){let c=n.createElement("button",{className:`${this.player.options.classPrefix}-menu-item`,textContent:o.t("player.auto"),attributes:{type:"button",role:"menuitem"}});this.player.renderer.hls&&this.player.renderer.hls.currentLevel===-1&&(c.classList.add(`${this.player.options.classPrefix}-menu-item-active`),c.appendChild(h("check"))),c.addEventListener("click",()=>{this.player.renderer.switchQuality&&this.player.renderer.switchQuality(-1),i.remove()}),i.appendChild(c)}s.forEach(c=>{let p=n.createElement("button",{className:`${this.player.options.classPrefix}-menu-item`,textContent:c.name||`${c.height}p`,attributes:{type:"button",role:"menuitem"}});c.index===a&&(p.classList.add(`${this.player.options.classPrefix}-menu-item-active`),p.appendChild(h("check"))),p.addEventListener("click",()=>{this.player.renderer.switchQuality&&this.player.renderer.switchQuality(c.index),i.remove()}),i.appendChild(p)})}}else{let s=n.createElement("div",{className:`${this.player.options.classPrefix}-menu-item`,textContent:o.t("player.noQuality"),style:{opacity:"0.5",cursor:"default"}});i.appendChild(s)}e.appendChild(i),this.attachMenuCloseHandler(i,e)}createCaptionStyleButton(){let e=n.createElement("button",{className:`${this.player.options.classPrefix}-button ${this.player.options.classPrefix}-caption-style`,attributes:{type:"button","aria-label":o.t("player.captionStyling"),"aria-haspopup":"menu",title:o.t("player.captionStyling")}}),t=n.createElement("span",{textContent:"Aa",style:{fontSize:"14px",fontWeight:"bold"}});return e.appendChild(t),e.addEventListener("click",()=>{this.showCaptionStyleMenu(e)}),this.controls.captionStyle=e,e}showCaptionStyleMenu(e){let t=document.querySelector(`.${this.player.options.classPrefix}-caption-style-menu`);if(t){t.remove();return}let i=n.createElement("div",{className:`${this.player.options.classPrefix}-caption-style-menu ${this.player.options.classPrefix}-menu ${this.player.options.classPrefix}-settings-menu`,attributes:{role:"menu","aria-label":o.t("player.captionStyling")}});if(i.addEventListener("click",d=>{d.stopPropagation()}),!this.player.captionManager||this.player.captionManager.tracks.length===0){let d=n.createElement("div",{className:`${this.player.options.classPrefix}-menu-item`,textContent:o.t("player.noCaptions"),style:{opacity:"0.5",cursor:"default",padding:"12px 16px"}});i.appendChild(d),e.appendChild(i),this.attachMenuCloseHandler(i,e,!0);return}let s=this.createStyleControl(o.t("styleLabels.fontSize"),"captionsFontSize",[{label:o.t("fontSizes.small"),value:"80%"},{label:o.t("fontSizes.medium"),value:"100%"},{label:o.t("fontSizes.large"),value:"120%"},{label:o.t("fontSizes.xlarge"),value:"150%"}]);i.appendChild(s);let a=this.createStyleControl(o.t("styleLabels.font"),"captionsFontFamily",[{label:o.t("fontFamilies.sansSerif"),value:"sans-serif"},{label:o.t("fontFamilies.serif"),value:"serif"},{label:o.t("fontFamilies.monospace"),value:"monospace"}]);i.appendChild(a);let r=this.createColorControl(o.t("styleLabels.textColor"),"captionsColor");i.appendChild(r);let c=this.createColorControl(o.t("styleLabels.background"),"captionsBackgroundColor");i.appendChild(c);let p=this.createOpacityControl(o.t("styleLabels.opacity"),"captionsOpacity");i.appendChild(p),i.style.minWidth="220px",e.appendChild(i),this.attachMenuCloseHandler(i,e,!0)}createStyleControl(e,t,i){let s=n.createElement("div",{className:`${this.player.options.classPrefix}-style-group`}),a=n.createElement("label",{textContent:e,style:{display:"block",fontSize:"12px",marginBottom:"4px",color:"rgba(255,255,255,0.7)"}});s.appendChild(a);let r=n.createElement("select",{className:`${this.player.options.classPrefix}-style-select`,style:{width:"100%",padding:"6px",background:"var(--vidply-white)",border:"1px solid var(--vidply-white-10)",borderRadius:"4px",color:"var(--vidply-black)",fontSize:"13px"}}),c=this.player.options[t];return i.forEach(p=>{let d=n.createElement("option",{textContent:p.label,attributes:{value:p.value}});p.value===c&&(d.selected=!0),r.appendChild(d)}),r.addEventListener("mousedown",p=>{p.stopPropagation()}),r.addEventListener("click",p=>{p.stopPropagation()}),r.addEventListener("change",p=>{p.stopPropagation(),this.player.options[t]=p.target.value,this.player.captionManager&&this.player.captionManager.setCaptionStyle(t.replace("captions","").charAt(0).toLowerCase()+t.replace("captions","").slice(1),p.target.value)}),s.appendChild(r),s}createColorControl(e,t){let i=n.createElement("div",{className:`${this.player.options.classPrefix}-style-group`}),s=n.createElement("label",{textContent:e,style:{display:"block",fontSize:"12px",marginBottom:"4px",color:"rgba(255,255,255,0.7)"}});i.appendChild(s);let a=n.createElement("input",{attributes:{type:"color",value:this.player.options[t]},style:{width:"100%",height:"32px",padding:"2px",background:"rgba(255,255,255,0.1)",border:"1px solid rgba(255,255,255,0.2)",borderRadius:"4px",cursor:"pointer"}});return a.addEventListener("mousedown",r=>{r.stopPropagation()}),a.addEventListener("click",r=>{r.stopPropagation()}),a.addEventListener("change",r=>{r.stopPropagation(),this.player.options[t]=r.target.value,this.player.captionManager&&this.player.captionManager.setCaptionStyle(t.replace("captions","").charAt(0).toLowerCase()+t.replace("captions","").slice(1),r.target.value)}),i.appendChild(a),i}createOpacityControl(e,t){let i=n.createElement("div",{className:`${this.player.options.classPrefix}-style-group`}),s=n.createElement("div",{style:{display:"flex",justifyContent:"space-between",marginBottom:"4px"}}),a=n.createElement("label",{textContent:e,style:{fontSize:"12px",color:"rgba(255,255,255,0.7)"}}),r=n.createElement("span",{textContent:Math.round(this.player.options[t]*100)+"%",style:{fontSize:"12px",color:"rgba(255,255,255,0.7)"}});s.appendChild(a),s.appendChild(r),i.appendChild(s);let c=n.createElement("input",{attributes:{type:"range",min:"0",max:"1",step:"0.1",value:String(this.player.options[t])},style:{width:"100%",cursor:"pointer"}});return c.addEventListener("mousedown",p=>{p.stopPropagation()}),c.addEventListener("click",p=>{p.stopPropagation()}),c.addEventListener("input",p=>{p.stopPropagation();let d=parseFloat(p.target.value);r.textContent=Math.round(d*100)+"%",this.player.options[t]=d,this.player.captionManager&&this.player.captionManager.setCaptionStyle(t.replace("captions","").charAt(0).toLowerCase()+t.replace("captions","").slice(1),d)}),i.appendChild(c),i}createSpeedButton(){let e=n.createElement("button",{className:`${this.player.options.classPrefix}-button ${this.player.options.classPrefix}-speed`,attributes:{type:"button","aria-label":o.t("player.speed"),"aria-haspopup":"menu"}});e.appendChild(h("speed"));let t=n.createElement("span",{className:`${this.player.options.classPrefix}-speed-text`,textContent:"1x"});return e.appendChild(t),e.addEventListener("click",()=>{this.showSpeedMenu(e)}),this.controls.speed=e,this.controls.speedText=t,e}formatSpeedLabel(e){return e===1?o.t("speeds.normal"):`${e.toLocaleString(o.getLanguage(),{minimumFractionDigits:0,maximumFractionDigits:2})}\xD7`}showSpeedMenu(e){let t=document.querySelector(`.${this.player.options.classPrefix}-speed-menu`);if(t){t.remove();return}let i=n.createElement("div",{className:`${this.player.options.classPrefix}-speed-menu ${this.player.options.classPrefix}-menu`,attributes:{role:"menu"}});[.25,.5,.75,1,1.25,1.5,1.75,2].forEach(a=>{let r=n.createElement("button",{className:`${this.player.options.classPrefix}-menu-item`,textContent:this.formatSpeedLabel(a),attributes:{type:"button",role:"menuitem"}});a===this.player.state.playbackSpeed&&(r.classList.add(`${this.player.options.classPrefix}-menu-item-active`),r.appendChild(h("check"))),r.addEventListener("click",()=>{this.player.setPlaybackSpeed(a),i.remove()}),i.appendChild(r)}),e.appendChild(i),this.attachMenuCloseHandler(i,e)}createCaptionsButton(){let e=n.createElement("button",{className:`${this.player.options.classPrefix}-button ${this.player.options.classPrefix}-captions-button`,attributes:{type:"button","aria-label":o.t("player.captions"),"aria-pressed":"false","aria-haspopup":"menu"}});return e.appendChild(h("captionsOff")),e.addEventListener("click",()=>{this.showCaptionsMenu(e)}),this.controls.captions=e,e}showCaptionsMenu(e){let t=document.querySelector(`.${this.player.options.classPrefix}-captions-menu`);if(t){t.remove();return}let i=n.createElement("div",{className:`${this.player.options.classPrefix}-captions-menu ${this.player.options.classPrefix}-menu`,attributes:{role:"menu","aria-label":o.t("captions.select")}});if(!this.player.captionManager||this.player.captionManager.tracks.length===0){let r=n.createElement("div",{className:`${this.player.options.classPrefix}-menu-item`,textContent:o.t("player.noCaptions"),style:{opacity:"0.5",cursor:"default"}});i.appendChild(r),e.appendChild(i),this.attachMenuCloseHandler(i,e);return}let s=n.createElement("button",{className:`${this.player.options.classPrefix}-menu-item`,textContent:o.t("captions.off"),attributes:{type:"button",role:"menuitem"}});this.player.state.captionsEnabled||(s.classList.add(`${this.player.options.classPrefix}-menu-item-active`),s.appendChild(h("check"))),s.addEventListener("click",()=>{this.player.disableCaptions(),this.updateCaptionsButton(),i.remove()}),i.appendChild(s),this.player.captionManager.getAvailableTracks().forEach(r=>{let c=n.createElement("button",{className:`${this.player.options.classPrefix}-menu-item`,textContent:r.label,attributes:{type:"button",role:"menuitem",lang:r.language}});this.player.state.captionsEnabled&&this.player.captionManager.currentTrack===this.player.captionManager.tracks[r.index]&&(c.classList.add(`${this.player.options.classPrefix}-menu-item-active`),c.appendChild(h("check"))),c.addEventListener("click",()=>{this.player.captionManager.switchTrack(r.index),this.updateCaptionsButton(),i.remove()}),i.appendChild(c)}),e.appendChild(i),this.attachMenuCloseHandler(i,e)}updateCaptionsButton(){if(!this.controls.captions)return;let e=this.controls.captions.querySelector(".vidply-icon"),t=this.player.state.captionsEnabled;e.innerHTML=t?h("captions").innerHTML:h("captionsOff").innerHTML,this.controls.captions.setAttribute("aria-pressed",t?"true":"false")}createTranscriptButton(){let e=n.createElement("button",{className:`${this.player.options.classPrefix}-button ${this.player.options.classPrefix}-transcript`,attributes:{type:"button","aria-label":o.t("player.transcript"),"aria-pressed":"false"}});return e.appendChild(h("transcript")),e.addEventListener("click",()=>{this.player.transcriptManager&&(this.player.transcriptManager.toggleTranscript(),this.updateTranscriptButton())}),this.controls.transcript=e,e}updateTranscriptButton(){if(!this.controls.transcript)return;let e=this.player.transcriptManager&&this.player.transcriptManager.isVisible;this.controls.transcript.setAttribute("aria-pressed",e?"true":"false")}createAudioDescriptionButton(){let e=n.createElement("button",{className:`${this.player.options.classPrefix}-button ${this.player.options.classPrefix}-audio-description`,attributes:{type:"button","aria-label":o.t("player.audioDescription"),"aria-pressed":"false",title:o.t("player.audioDescription")}});return e.appendChild(h("audioDescription")),e.addEventListener("click",async()=>{await this.player.toggleAudioDescription(),this.updateAudioDescriptionButton()}),this.controls.audioDescription=e,e}updateAudioDescriptionButton(){if(!this.controls.audioDescription)return;let e=this.controls.audioDescription.querySelector(".vidply-icon"),t=this.player.state.audioDescriptionEnabled;e.innerHTML=t?h("audioDescriptionOn").innerHTML:h("audioDescription").innerHTML,this.controls.audioDescription.setAttribute("aria-pressed",t?"true":"false"),this.controls.audioDescription.setAttribute("aria-label",t?o.t("audioDescription.disable"):o.t("audioDescription.enable"))}createSignLanguageButton(){let e=n.createElement("button",{className:`${this.player.options.classPrefix}-button ${this.player.options.classPrefix}-sign-language`,attributes:{type:"button","aria-label":o.t("player.signLanguage"),"aria-pressed":"false",title:o.t("player.signLanguage")}});return e.appendChild(h("signLanguage")),e.addEventListener("click",()=>{this.player.toggleSignLanguage(),this.updateSignLanguageButton()}),this.controls.signLanguage=e,e}updateSignLanguageButton(){if(!this.controls.signLanguage)return;let e=this.controls.signLanguage.querySelector(".vidply-icon"),t=this.player.state.signLanguageEnabled;e.innerHTML=t?h("signLanguageOn").innerHTML:h("signLanguage").innerHTML,this.controls.signLanguage.setAttribute("aria-pressed",t?"true":"false"),this.controls.signLanguage.setAttribute("aria-label",t?o.t("signLanguage.hide"):o.t("signLanguage.show"))}createSettingsButton(){let e=n.createElement("button",{className:`${this.player.options.classPrefix}-button ${this.player.options.classPrefix}-settings`,attributes:{type:"button","aria-label":o.t("player.settings")}});return e.appendChild(h("settings")),e.addEventListener("click",()=>{this.player.showSettings()}),e}createPipButton(){let e=n.createElement("button",{className:`${this.player.options.classPrefix}-button ${this.player.options.classPrefix}-pip`,attributes:{type:"button","aria-label":o.t("player.pip")}});return e.appendChild(h("pip")),e.addEventListener("click",()=>{this.player.togglePiP()}),e}createFullscreenButton(){let e=n.createElement("button",{className:`${this.player.options.classPrefix}-button ${this.player.options.classPrefix}-fullscreen`,attributes:{type:"button","aria-label":o.t("player.fullscreen")}});return e.appendChild(h("fullscreen")),e.addEventListener("click",()=>{this.player.toggleFullscreen()}),this.controls.fullscreen=e,e}attachEvents(){this.player.on("play",()=>this.updatePlayPauseButton()),this.player.on("pause",()=>this.updatePlayPauseButton()),this.player.on("timeupdate",()=>this.updateProgress()),this.player.on("loadedmetadata",()=>{this.updateDuration(),this.ensureQualityButton(),this.updateQualityIndicator()}),this.player.on("volumechange",()=>this.updateVolumeDisplay()),this.player.on("progress",()=>this.updateBuffered()),this.player.on("playbackspeedchange",()=>this.updateSpeedDisplay()),this.player.on("fullscreenchange",()=>this.updateFullscreenButton()),this.player.on("captionsenabled",()=>this.updateCaptionsButton()),this.player.on("captionsdisabled",()=>this.updateCaptionsButton()),this.player.on("audiodescriptionenabled",()=>this.updateAudioDescriptionButton()),this.player.on("audiodescriptiondisabled",()=>this.updateAudioDescriptionButton()),this.player.on("signlanguageenabled",()=>this.updateSignLanguageButton()),this.player.on("signlanguagedisabled",()=>this.updateSignLanguageButton()),this.player.on("qualitychange",()=>this.updateQualityIndicator()),this.player.on("hlslevelswitched",()=>this.updateQualityIndicator()),this.player.on("hlsmanifestparsed",()=>{this.ensureQualityButton(),this.updateQualityIndicator()})}updatePlayPauseButton(){if(!this.controls.playPause)return;let e=this.controls.playPause.querySelector(".vidply-icon"),t=this.player.state.playing;e.innerHTML=t?h("pause").innerHTML:h("play").innerHTML,this.controls.playPause.setAttribute("aria-label",t?o.t("player.pause"):o.t("player.play"))}updateProgress(){if(!this.controls.played)return;let e=this.player.state.currentTime/this.player.state.duration*100;this.controls.played.style.width=`${e}%`,this.controls.progress.setAttribute("aria-valuenow",String(Math.round(e))),this.controls.currentTimeDisplay&&(this.controls.currentTimeDisplay.textContent=m.formatTime(this.player.state.currentTime))}updateDuration(){this.controls.durationDisplay&&(this.controls.durationDisplay.textContent=m.formatTime(this.player.state.duration))}updateVolumeDisplay(){if(!this.controls.volumeFill)return;let e=this.player.state.volume*100;if(this.controls.volumeFill.style.height=`${e}%`,this.controls.mute){let t=this.controls.mute.querySelector(".vidply-icon"),i;this.player.state.muted||this.player.state.volume===0?i="volumeMuted":this.player.state.volume<.3?i="volumeLow":this.player.state.volume<.7?i="volumeMedium":i="volumeHigh",t.innerHTML=h(i).innerHTML,this.controls.mute.setAttribute("aria-label",this.player.state.muted?o.t("player.unmute"):o.t("player.mute"))}this.controls.volumeSlider&&this.controls.volumeSlider.setAttribute("aria-valuenow",String(Math.round(e)))}updateBuffered(){if(!this.controls.buffered||!this.player.element.buffered||this.player.element.buffered.length===0)return;let t=this.player.element.buffered.end(this.player.element.buffered.length-1)/this.player.state.duration*100;this.controls.buffered.style.width=`${t}%`}updateSpeedDisplay(){this.controls.speedText&&(this.controls.speedText.textContent=`${this.player.state.playbackSpeed}x`)}updateFullscreenButton(){if(!this.controls.fullscreen)return;let e=this.controls.fullscreen.querySelector(".vidply-icon"),t=this.player.state.fullscreen;e.innerHTML=t?h("fullscreenExit").innerHTML:h("fullscreen").innerHTML,this.controls.fullscreen.setAttribute("aria-label",t?o.t("player.exitFullscreen"):o.t("player.fullscreen"))}ensureQualityButton(){if(!this.player.options.qualityButton||this.controls.quality||!this.hasQualityLevels())return;let e=this.createQualityButton(),t=this.rightButtons.querySelector(`.${this.player.options.classPrefix}-speed`),s=this.rightButtons.querySelector(`.${this.player.options.classPrefix}-caption-style`)||t;s?this.rightButtons.insertBefore(e,s):this.rightButtons.insertBefore(e,this.rightButtons.firstChild),this.player.log("Quality button added dynamically","info")}updateQualityIndicator(){if(!this.controls.qualityText||!this.player.renderer||!this.player.renderer.getQualities)return;let e=this.player.renderer.getQualities();if(e.length===0){this.controls.qualityText.textContent="";return}let t="";if(this.player.renderer.hls&&this.player.renderer.hls.currentLevel===-1)t="Auto";else if(this.player.renderer.getCurrentQuality){let i=this.player.renderer.getCurrentQuality(),s=e.find(a=>a.index===i);s&&(t=s.height?`${s.height}p`:"")}this.controls.qualityText.textContent=t}setupAutoHide(){if(this.player.element.tagName!=="VIDEO")return;let e=()=>{this.element.classList.add(`${this.player.options.classPrefix}-controls-visible`),this.player.container.classList.add(`${this.player.options.classPrefix}-controls-visible`),this.player.state.controlsVisible=!0,clearTimeout(this.hideTimeout),this.player.state.playing&&(this.hideTimeout=setTimeout(()=>{this.element.classList.remove(`${this.player.options.classPrefix}-controls-visible`),this.player.container.classList.remove(`${this.player.options.classPrefix}-controls-visible`),this.player.state.controlsVisible=!1},this.player.options.hideControlsDelay))};this.player.container.addEventListener("mousemove",e),this.player.container.addEventListener("touchstart",e),this.player.container.addEventListener("click",e),this.element.addEventListener("focusin",e),this.player.on("pause",()=>{e(),clearTimeout(this.hideTimeout)}),this.player.on("play",()=>{e()}),e()}show(){this.element.style.display=""}hide(){this.element.style.display="none"}destroy(){this.hideTimeout&&clearTimeout(this.hideTimeout),this.element&&this.element.parentNode&&this.element.parentNode.removeChild(this.element)}};var f=class{constructor(e){this.player=e,this.element=null,this.tracks=[],this.currentTrack=null,this.currentCue=null,this.init()}init(){this.createElement(),this.loadTracks(),this.attachEvents(),this.player.options.captionsDefault&&this.tracks.length>0&&this.enable()}createElement(){this.element=n.createElement("div",{className:`${this.player.options.classPrefix}-captions`,attributes:{"aria-live":"polite","aria-atomic":"true",role:"region","aria-label":o.t("player.captions")}}),this.updateStyles(),(this.player.videoWrapper||this.player.container).appendChild(this.element)}loadTracks(){let e=this.player.element.textTracks;for(let t=0;t<e.length;t++){let i=e[t];(i.kind==="subtitles"||i.kind==="captions")&&(this.tracks.push({track:i,language:i.language,label:i.label,kind:i.kind,index:t}),i.mode="hidden")}}attachEvents(){this.player.on("timeupdate",()=>{this.updateCaptions()}),this.player.on("captionschange",()=>{this.updateStyles()})}enable(e=0){if(this.tracks.length===0)return;this.currentTrack&&(this.currentTrack.track.mode="hidden");let t=this.tracks[e];t&&(t.track.mode="hidden",this.currentTrack=t,this.player.state.captionsEnabled=!0,this.cueChangeHandler&&t.track.removeEventListener("cuechange",this.cueChangeHandler),this.cueChangeHandler=()=>{this.updateCaptions()},t.track.addEventListener("cuechange",this.cueChangeHandler),this.element.style.display="block",this.player.emit("captionsenabled",t))}disable(){this.currentTrack&&(this.currentTrack.track.mode="hidden",this.currentTrack=null),this.element.style.display="none",this.element.innerHTML="",this.currentCue=null,this.player.state.captionsEnabled=!1,this.player.emit("captionsdisabled")}updateCaptions(){if(!this.currentTrack||!this.currentTrack.track.activeCues)return;let e=this.currentTrack.track.activeCues;if(e.length>0){let t=e[0];if(this.currentCue!==t){this.currentCue=t;let i=t.text;i=this.parseVTTFormatting(i),this.element.innerHTML=n.sanitizeHTML(i),this.element.style.display="block",this.player.emit("captionchange",t)}}else this.currentCue&&(this.element.innerHTML="",this.element.style.display="none",this.currentCue=null)}parseVTTFormatting(e){return e=e.replace(/<c[^>]*>(.*?)<\/c>/g,'<span class="caption-class">$1</span>'),e=e.replace(/<b>(.*?)<\/b>/g,"<strong>$1</strong>"),e=e.replace(/<i>(.*?)<\/i>/g,"<em>$1</em>"),e=e.replace(/<u>(.*?)<\/u>/g,"<u>$1</u>"),e=e.replace(/<v\s+([^>]+)>(.*?)<\/v>/g,'<span class="caption-voice" data-voice="$1">$2</span>'),e}updateStyles(){if(!this.element)return;let e=this.player.options;this.element.style.fontSize=e.captionsFontSize,this.element.style.fontFamily=e.captionsFontFamily,this.element.style.color=e.captionsColor,this.element.style.backgroundColor=this.hexToRgba(e.captionsBackgroundColor,e.captionsOpacity)}hexToRgba(e,t){let i=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e);return i?`rgba(${parseInt(i[1],16)}, ${parseInt(i[2],16)}, ${parseInt(i[3],16)}, ${t})`:e}setCaptionStyle(e,t){switch(e){case"fontSize":this.player.options.captionsFontSize=t;break;case"fontFamily":this.player.options.captionsFontFamily=t;break;case"color":this.player.options.captionsColor=t;break;case"backgroundColor":this.player.options.captionsBackgroundColor=t;break;case"opacity":this.player.options.captionsOpacity=t;break}this.updateStyles(),this.player.emit("captionschange")}getAvailableTracks(){return this.tracks.map((e,t)=>({index:t,language:e.language,label:e.label||e.language,kind:e.kind}))}switchTrack(e){e>=0&&e<this.tracks.length&&(this.disable(),this.enable(e))}destroy(){this.disable(),this.element&&this.element.parentNode&&this.element.parentNode.removeChild(this.element)}};var E=class{constructor(e){this.player=e,this.shortcuts=e.options.keyboardShortcuts,this.init()}init(){this.attachEvents()}attachEvents(){this.player.container.addEventListener("keydown",e=>{this.handleKeydown(e)}),this.player.container.hasAttribute("tabindex")||this.player.container.setAttribute("tabindex","0")}handleKeydown(e){if(e.target.tagName==="INPUT"||e.target.tagName==="TEXTAREA"||e.target.tagName==="SELECT")return;let t=e.key,i=!1;for(let[s,a]of Object.entries(this.shortcuts))if(a.includes(t)&&(i=this.executeAction(s,e),i)){e.preventDefault(),e.stopPropagation(),this.announceAction(s);break}}executeAction(e,t){switch(e){case"play-pause":return this.player.toggle(),!0;case"volume-up":return this.player.setVolume(Math.min(1,this.player.state.volume+.1)),!0;case"volume-down":return this.player.setVolume(Math.max(0,this.player.state.volume-.1)),!0;case"seek-forward":return this.player.seekForward(),!0;case"seek-backward":return this.player.seekBackward(),!0;case"seek-forward-large":return this.player.seekForward(this.player.options.seekIntervalLarge),!0;case"seek-backward-large":return this.player.seekBackward(this.player.options.seekIntervalLarge),!0;case"mute":return this.player.toggleMute(),!0;case"fullscreen":return this.player.toggleFullscreen(),!0;case"captions":if(this.player.captionManager&&this.player.captionManager.tracks.length>1){let i=document.querySelector(".vidply-captions");i&&this.player.controlBar&&this.player.controlBar.showCaptionsMenu(i)}else this.player.toggleCaptions();return!0;case"speed-up":return this.player.setPlaybackSpeed(Math.min(2,this.player.state.playbackSpeed+.25)),!0;case"speed-down":return this.player.setPlaybackSpeed(Math.max(.25,this.player.state.playbackSpeed-.25)),!0;case"settings":return this.player.showSettings(),!0;default:return!1}}announceAction(e){if(!this.player.options.screenReaderAnnouncements)return;let t="";switch(e){case"play-pause":t=this.player.state.playing?"Playing":"Paused";break;case"volume-up":t=`Volume ${Math.round(this.player.state.volume*100)}%`;break;case"volume-down":t=`Volume ${Math.round(this.player.state.volume*100)}%`;break;case"mute":t=this.player.state.muted?"Muted":"Unmuted";break;case"fullscreen":t=this.player.state.fullscreen?"Fullscreen":"Exit fullscreen";break;case"captions":t=this.player.state.captionsEnabled?"Captions on":"Captions off";break;case"speed-up":case"speed-down":t=`Speed ${this.player.state.playbackSpeed}x`;break}t&&this.announce(t)}announce(e,t="polite"){let i=document.getElementById("vidply-announcer");i||(i=document.createElement("div"),i.id="vidply-announcer",i.className="vidply-sr-only",i.setAttribute("aria-live",t),i.setAttribute("aria-atomic","true"),i.style.cssText=`
    ...
    `,this.trackInfoElement.style.display="block"}renderPlaylist(){if(!this.playlistPanel)return;this.playlistPanel.innerHTML="";let e=n.createElement("div",{className:"vidply-playlist-header"});e.textContent=`Playlist (${this.tracks.length})`,this.playlistPanel.appendChild(e);let t=n.createElement("div",{className:"vidply-playlist-list"});this.tracks.forEach((i,s)=>{let a=this.createPlaylistItem(i,s);t.appendChild(a)}),this.playlistPanel.appendChild(t),this.playlistPanel.style.display="block"}createPlaylistItem(e,t){let i=n.createElement("div",{className:"vidply-playlist-item",role:"button",tabIndex:0,"aria-label":`Play ${e.title||"Track "+(t+1)}`});t===this.currentIndex&&i.classList.add("vidply-playlist-item-active");let s=n.createElement("div",{className:"vidply-playlist-thumbnail"});if(e.poster)s.style.backgroundImage=`url(${e.poster})`;else{let p=h("music");p.classList.add("vidply-playlist-thumbnail-icon"),s.appendChild(p)}i.appendChild(s);let a=n.createElement("div",{className:"vidply-playlist-item-info"}),r=n.createElement("div",{className:"vidply-playlist-item-title"});if(r.textContent=e.title||`Track ${t+1}`,a.appendChild(r),e.artist){let p=n.createElement("div",{className:"vidply-playlist-item-artist"});p.textContent=e.artist,a.appendChild(p)}i.appendChild(a);let c=h("play");return c.classList.add("vidply-playlist-item-icon"),i.appendChild(c),i.addEventListener("click",()=>{this.play(t)}),i.addEventListener("keydown",p=>{(p.key==="Enter"||p.key===" ")&&(p.preventDefault(),this.play(t))}),i}updatePlaylistUI(){if(!this.playlistPanel)return;this.playlistPanel.querySelectorAll(".vidply-playlist-item").forEach((t,i)=>{i===this.currentIndex?(t.classList.add("vidply-playlist-item-active"),t.scrollIntoView({behavior:"smooth",block:"nearest"})):t.classList.remove("vidply-playlist-item-active")})}getCurrentTrack(){return this.tracks[this.currentIndex]||null}getPlaylistInfo(){return{currentIndex:this.currentIndex,totalTracks:this.tracks.length,currentTrack:this.getCurrentTrack(),hasNext:this.currentIndex<this.tracks.length-1,hasPrevious:this.currentIndex>0}}addTrack(e){this.tracks.push(e),this.playlistPanel&&this.renderPlaylist()}removeTrack(e){e<0||e>=this.tracks.length||(this.tracks.splice(e,1),e<this.currentIndex?this.currentIndex--:e===this.currentIndex&&(this.currentIndex>=this.tracks.length&&(this.currentIndex=this.tracks.length-1),this.currentIndex>=0&&this.play(this.currentIndex)),this.playlistPanel&&this.renderPlaylist())}clear(){this.tracks=[],this.currentIndex=-1,this.playlistPanel&&(this.playlistPanel.innerHTML="",this.playlistPanel.style.display="none"),this.trackInfoElement&&(this.trackInfoElement.innerHTML="",this.trackInfoElement.style.display="none")}destroy(){this.player.off("ended",this.handleTrackEnd),this.player.off("error",this.handleTrackError),this.trackInfoElement&&this.trackInfoElement.remove(),this.playlistPanel&&this.playlistPanel.remove(),this.clear()}};function N(){document.querySelectorAll("[data-vidply]").forEach(e=>{let t=e.dataset.vidplyOptions?JSON.parse(e.dataset.vidplyOptions):{},s={...O(e.dataset),...t};new g(e,s)})}function O(l){let e={},t={signLanguageSrc:"signLanguageSrc",signLanguageButton:"signLanguageButton",signLanguagePosition:"signLanguagePosition",audioDescriptionSrc:"audioDescriptionSrc",audioDescriptionButton:"audioDescriptionButton",autoplay:"autoplay",loop:"loop",muted:"muted",controls:"controls",poster:"poster",width:"width",height:"height",language:"language",captions:"captions",captionsDefault:"captionsDefault",transcript:"transcript",transcriptButton:"transcriptButton",keyboard:"keyboard",responsive:"responsive",pipButton:"pipButton",fullscreenButton:"fullscreenButton"};return Object.keys(t).forEach(i=>{let s=t[i],a=l[i];a!==void 0&&(a==="true"?e[s]=!0:a==="false"?e[s]=!1:!isNaN(a)&&a!==""?e[s]=Number(a):e[s]=a)}),e}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",N):N();var Ie=g;export{g as Player,$ as PlaylistManager,Ie as default};
