...
var N=Object.defineProperty;var D=(l,e)=>()=>(l&&(e=l(l=0)),e);var A=(l,e)=>{for(var t in e)N(l,t,{get:e[t],enumerable:!0})};var H={};A(H,{HTML5Renderer:()=>v});var v,M=D(()=>{v=class{constructor(e){this.player=e,this.media=e.element}async init(){this.attachEvents(),this.media.preload=this.player.options.preload,this.media.load()}attachEvents(){this.media.addEventListener("loadedmetadata",()=>{this.player.state.duration=this.media.duration,this.player.emit("loadedmetadata")}),this.media.addEventListener("play",()=>{this.player.state.playing=!0,this.player.state.paused=!1,this.player.state.ended=!1,this.player.emit("play"),this.player.options.onPlay&&this.player.options.onPlay.call(this.player),this.player.options.pauseOthersOnPlay&&this.pauseOtherPlayers()}),this.media.addEventListener("pause",()=>{this.player.state.playing=!1,this.player.state.paused=!0,this.player.emit("pause"),this.player.options.onPause&&this.player.options.onPause.call(this.player)}),this.media.addEventListener("ended",()=>{this.player.state.playing=!1,this.player.state.paused=!0,this.player.state.ended=!0,this.player.emit("ended"),this.player.options.onEnded&&this.player.options.onEnded.call(this.player),this.player.options.loop&&(this.player.seek(0),this.player.play())}),this.media.addEventListener("timeupdate",()=>{this.player.state.currentTime=this.media.currentTime,this.player.emit("timeupdate",this.media.currentTime),this.player.options.onTimeUpdate&&this.player.options.onTimeUpdate.call(this.player,this.media.currentTime)}),this.media.addEventListener("volumechange",()=>{this.player.state.volume=this.media.volume,this.player.state.muted=this.media.muted,this.player.emit("volumechange",this.media.volume),this.player.options.onVolumeChange&&this.player.options.onVolumeChange.call(this.player,this.media.volume)}),this.media.addEventListener("seeking",()=>{this.player.state.seeking=!0,this.player.emit("seeking")}),this.media.addEventListener("seeked",()=>{this.player.state.seeking=!1,this.player.emit("seeked")}),this.media.addEventListener("waiting",()=>{this.player.state.buffering=!0,this.player.emit("waiting")}),this.media.addEventListener("canplay",()=>{this.player.state.buffering=!1,this.player.emit("canplay")}),this.media.addEventListener("progress",()=>{if(this.media.buffered.length>0){let e=this.media.buffered.end(this.media.buffered.length-1);this.player.emit("progress",e)}}),this.media.addEventListener("error",e=>{this.player.handleError(this.media.error)}),this.media.addEventListener("ratechange",()=>{this.player.state.playbackSpeed=this.media.playbackRate,this.player.emit("ratechange",this.media.playbackRate)})}pauseOtherPlayers(){document.querySelectorAll(".vidply-player").forEach(t=>{if(t!==this.player.container){let s=t.querySelector("video, audio");s&&!s.paused&&s.pause()}})}play(){let e=this.media.play();e!==void 0&&e.catch(t=>{this.player.log("Play failed:",t,"warn"),this.player.options.autoplay&&!this.player.state.muted&&(this.player.log("Retrying play with muted audio","info"),this.media.muted=!0,this.media.play().catch(s=>{this.player.handleError(s)}))})}pause(){this.media.pause()}seek(e){this.media.currentTime=e}setVolume(e){this.media.volume=e}setMuted(e){this.media.muted=e}setPlaybackSpeed(e){this.media.playbackRate=e}destroy(){this.media.removeEventListener("loadedmetadata",()=>{}),this.media.removeEventListener("play",()=>{}),this.media.removeEventListener("pause",()=>{})}}});var b=class{constructor(){this.events={}}on(e,t){return this.events[e]||(this.events[e]=[]),this.events[e].push(t),this}once(e,t){let s=(...i)=>{t(...i),this.off(e,s)};return this.on(e,s)}off(e,t){return this.events[e]?(t?this.events[e]=this.events[e].filter(s=>s!==t):delete this.events[e],this):this}emit(e,...t){return this.events[e]?(this.events[e].forEach(s=>{s(...t)}),this):this}removeAllListeners(){return this.events={},this}};var n={createElement(l,e={}){let t=document.createElement(l);return e.className&&(t.className=e.className),e.attributes&&Object.entries(e.attributes).forEach(([s,i])=>{t.setAttribute(s,i)}),e.innerHTML&&(t.innerHTML=e.innerHTML),e.textContent&&(t.textContent=e.textContent),e.style&&Object.assign(t.style,e.style),e.children&&e.children.forEach(s=>{s&&t.appendChild(s)}),t},addClass(l,e){l&&e&&l.classList.add(e)},removeClass(l,e){l&&e&&l.classList.remove(e)},toggleClass(l,e){l&&e&&l.classList.toggle(e)},hasClass(l,e){return l&&l.classList.contains(e)},show(l){l&&(l.style.display="")},hide(l){l&&(l.style.display="none")},fadeIn(l,e=300){if(!l)return;l.style.opacity="0",l.style.display="";let t=null,s=i=>{t||(t=i);let a=i-t,r=Math.min(a/e,1);l.style.opacity=r,a<e&&requestAnimationFrame(s)};requestAnimationFrame(s)},fadeOut(l,e=300){if(!l)return;let t=parseFloat(getComputedStyle(l).opacity)||1,s=null,i=a=>{s||(s=a);let r=a-s,o=Math.max(t-r/e,0);l.style.opacity=o,r<e?requestAnimationFrame(i):l.style.display="none"};requestAnimationFrame(i)},offset(l){if(!l)return{top:0,left:0};let e=l.getBoundingClientRect();return{top:e.top+window.pageYOffset,left:e.left+window.pageXOffset,width:e.width,height:e.height}},escapeHTML(l){let e=document.createElement("div");return e.textContent=l,e.innerHTML},sanitizeHTML(l){let e=document.createElement("div"),t=l.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,"").replace(/<iframe\b[^<]*(?:(?!<\/iframe>)<[^<]*)*<\/iframe>/gi,"").replace(/on\w+\s*=/gi,"").replace(/javascript:/gi,"");return e.innerHTML=t,e.innerHTML}};var m={formatTime(l,e=!1){if(!isFinite(l)||l<0)return e?"00:00:00":"00:00";let t=Math.floor(l/3600),s=Math.floor(l%3600/60),i=Math.floor(l%60),a=r=>String(r).padStart(2,"0");return t>0||e?`${a(t)}:${a(s)}:${a(i)}`:`${a(s)}:${a(i)}`},parseTime(l){let e=l.split(":").map(t=>parseInt(t,10));return e.length===3?e[0]*3600+e[1]*60+e[2]:e.length===2?e[0]*60+e[1]:e.length===1?e[0]:0},formatDuration(l){if(!isFinite(l)||l<0)return"0 seconds";let e=Math.floor(l/3600),t=Math.floor(l%3600/60),s=Math.floor(l%60),i=[];return e>0&&i.push(`${e} hour${e!==1?"s":""}`),t>0&&i.push(`${t} minute${t!==1?"s":""}`),(s>0||i.length===0)&&i.push(`${s} second${s!==1?"s":""}`),i.join(", ")},formatPercentage(l,e){return e===0?0:Math.round(l/e*100)}};var $={play:`<svg viewBox="0 0 24 24" fill="currentColor">
    ...
    `,this.trackInfoElement.style.display="block"}renderPlaylist(){if(!this.playlistPanel)return;this.playlistPanel.innerHTML="";let e=n.createElement("div",{className:"vidply-playlist-header"});e.textContent=`Playlist (${this.tracks.length})`,this.playlistPanel.appendChild(e);let t=n.createElement("div",{className:"vidply-playlist-list"});this.tracks.forEach((s,i)=>{let a=this.createPlaylistItem(s,i);t.appendChild(a)}),this.playlistPanel.appendChild(t),this.playlistPanel.style.display="block"}createPlaylistItem(e,t){let s=n.createElement("div",{className:"vidply-playlist-item",role:"button",tabIndex:0,"aria-label":`Play ${e.title||"Track "+(t+1)}`});if(t===this.currentIndex&&s.classList.add("vidply-playlist-item-active"),e.poster){let o=n.createElement("div",{className:"vidply-playlist-thumbnail"});o.style.backgroundImage=`url(${e.poster})`,s.appendChild(o)}let i=n.createElement("div",{className:"vidply-playlist-item-info"}),a=n.createElement("div",{className:"vidply-playlist-item-title"});if(a.textContent=e.title||`Track ${t+1}`,i.appendChild(a),e.artist){let o=n.createElement("div",{className:"vidply-playlist-item-artist"});o.textContent=e.artist,i.appendChild(o)}s.appendChild(i);let r=h("play");return r.classList.add("vidply-playlist-item-icon"),s.appendChild(r),s.addEventListener("click",()=>{this.play(t)}),s.addEventListener("keydown",o=>{(o.key==="Enter"||o.key===" ")&&(o.preventDefault(),this.play(t))}),s}updatePlaylistUI(){if(!this.playlistPanel)return;this.playlistPanel.querySelectorAll(".vidply-playlist-item").forEach((t,s)=>{s===this.currentIndex?(t.classList.add("vidply-playlist-item-active"),t.scrollIntoView({behavior:"smooth",block:"nearest"})):t.classList.remove("vidply-playlist-item-active")})}getCurrentTrack(){return this.tracks[this.currentIndex]||null}getPlaylistInfo(){return{currentIndex:this.currentIndex,totalTracks:this.tracks.length,currentTrack:this.getCurrentTrack(),hasNext:this.currentIndex<this.tracks.length-1,hasPrevious:this.currentIndex>0}}addTrack(e){this.tracks.push(e),this.playlistPanel&&this.renderPlaylist()}removeTrack(e){e<0||e>=this.tracks.length||(this.tracks.splice(e,1),e<this.currentIndex?this.currentIndex--:e===this.currentIndex&&(this.currentIndex>=this.tracks.length&&(this.currentIndex=this.tracks.length-1),this.currentIndex>=0&&this.play(this.currentIndex)),this.playlistPanel&&this.renderPlaylist())}clear(){this.tracks=[],this.currentIndex=-1,this.playlistPanel&&(this.playlistPanel.innerHTML="",this.playlistPanel.style.display="none"),this.trackInfoElement&&(this.trackInfoElement.innerHTML="",this.trackInfoElement.style.display="none")}destroy(){this.player.off("ended",this.handleTrackEnd),this.player.off("error",this.handleTrackError),this.trackInfoElement&&this.trackInfoElement.remove(),this.playlistPanel&&this.playlistPanel.remove(),this.clear()}};function B(){document.querySelectorAll("[data-vidply]").forEach(e=>{let t=e.dataset.vidplyOptions?JSON.parse(e.dataset.vidplyOptions):{};new g(e,t)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",B):B();var He=g;export{g as Player,S as PlaylistManager,He as default};
