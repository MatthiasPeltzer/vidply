...
(() => {
      ...
      HTML5Renderer = class {
        ...
        attachEvents() {
          ...
          this.media.addEventListener("emptied", () => {
            var _a, _b;
            (_b = (_a = this.player).syncPlaybackUiFromMediaElement) == null ? void 0 : _b.call(_a);
          }, { signal });
          ...
          if (promise !== void 0) {
            promise.catch((error) => {
              ...
              if (this.player.options.autoplay && !this.player.state.muted) {
                ...
                this.media.play().catch((err2) => {
                  this.player.handleError(err2);
                });
              }
            });
            return promise;
  ...
  var init_HLSRenderer = __esm({
    "src/renderers/HLSRenderer.ts"() {
      ...
      HLSRenderer = class {
        ...
        elementSourceMatches(src) {
          const current = this.media.currentSrc || this.media.getAttribute("src") || this.media.src || "";
          if (!current) {
            return false;
          }
          try {
            return new URL(src, window.location.href).href === new URL(current, window.location.href).href;
          } catch {
            return src === current;
          }
        }
  ...
  function negotiateMediaSources(candidates, options) {
    ...
    const preferNative = (options == null ? void 0 : options.preferNativeElement) === true;
    let chosen;
    if (preferNative) {
  ...
  var _DebugOverlay = class _DebugOverlay {
    constructor() {
      ...
      __publicField(this, "mediaListenerController", null);
    }
    ...
    mount() {
      ...
      copyBtn.addEventListener("click", () => {
        var _a;
        void ((_a = navigator.clipboard) == null ? void 0 : _a.writeText(this.lines.join("\n")).catch(() => {
        }));
      });
    ...
    destroyInternal() {
      var _a, _b;
      (_a = this.mediaListenerController) == null ? void 0 : _a.abort();
    ...
    append(message, player) {
      ...
      const el = active == null ? void 0 : active.element;
    ...
    attachMediaListeners() {
      var _a, _b;
      const media = (_a = this.player) == null ? void 0 : _a.element;
      if (!(media instanceof HTMLMediaElement)) {
        return;
      }
      (_b = this.mediaListenerController) == null ? void 0 : _b.abort();
        ...
        media.addEventListener(
          ...
          () => {
            ...
            if (type === "error" && media.error) {
              ...
              const msg = (_a2 = media.error.message) == null ? void 0 : _a2.trim();
  ...
  __publicField(_DebugOverlay, "shared", null);
  __publicField(_DebugOverlay, "refCount", 0);
  ...
  function formatUnknownForLog(value, media) {
    ...
    if (asMedia && typeof asMedia.code === "number") {
      ...
      const msg = (_a = asMedia.message) == null ? void 0 : _a.trim();
      return msg ? `${label}: ${msg}` : label;
    }
    const elErr = (media == null ? void 0 : media.error) ?? null;
    if (elErr && (value === null || value === void 0 || typeof value === "object" && !Array.isArray(value) && Object.keys(value).length === 0)) {
      ...
      const msg = (_b = elErr.message) == null ? void 0 : _b.trim();
      return msg ? `${label}: ${msg}` : label;
    }
    try {
  ...
  var _Player = class _Player extends EventEmitter {
    constructor(element, options = {}) {
      ...
      __publicField(this, "debugOverlay", null);
      ...
      __publicField(this, "_rendererInitInFlight", null);
      __publicField(this, "_playRequestedDuringRendererInit", false);
      /** Set during {@link load} when iOS primed playback must survive {@link initializeRenderer}. */
      __publicField(this, "_preservePlaybackDuringRendererInit", false);
    ...
    async initializeRenderer() {
      ...
      const runInit = async () => {
        ...
        const initTimeout = (((_a2 = this._fallbackSources) == null ? void 0 : _a2.length) ?? 0) > 0 ? 1e4 : 0;
        if (initTimeout > 0) {
          let timer;
          await Promise.race([
            this.renderer.init(),
      ...
      try {
        ...
        if (this._playRequestedDuringRendererInit) {
          ...
          if (isIOS()) {
            (_e = this.syncPlaybackUiFromMediaElement) == null ? void 0 : _e.call(this);
            if (!this.element.paused) {
              (_f = this.hidePosterOverlay) == null ? void 0 : _f.call(this);
            }
          } else {
            this.play();
          }
    ...
    async load(config) {
      ...
      try {
        ...
        this._preservePlaybackDuringRendererInit = false;
        (_e = (_d = this.playlistManager) == null ? void 0 : _d.tryConsumePendingUserPlay) == null ? void 0 : _e.call(_d);
      }
    }
    /**
    ...
    resetPlaybackStateForSourceChange(options) {
      var _a, _b;
      const pauseElement = (options == null ? void 0 : options.pauseElement) !== false;
      if (pauseElement) {
        try {
          this.element.pause();
        } catch {
      ...
      const prefix = this.options.classPrefix;
      (_a = this.container) == null ? void 0 : _a.classList.remove(`${prefix}-buffering`);
      if (this.loadingOverlayElement) {
        this.loadingOverlayElement.setAttribute("aria-busy", "false");
      }
      (_b = this.controlBar) == null ? void 0 : _b.updatePlayPauseButton();
    }
    ...
    syncPlaybackUiFromMediaElement() {
      ...
      if (overlayNode) {
        if (playing) {
          ...
          (_b = this.playButtonOverlayButton) == null ? void 0 : _b.setAttribute("aria-label", i18n.t("player.pause"));
        } else if (!el.ended) {
          overlayNode.style.opacity = "1";
          overlayNode.style.pointerEvents = "auto";
          (_c = this.playButtonOverlayButton) == null ? void 0 : _c.setAttribute("aria-label", i18n.t("player.play"));
        }
      }
    }
    /**
    ...
    teardownRendererForNativeGestureSwap() {
      ...
      if (this.renderer) {
        this.renderer.destroy();
        this.renderer = null;
        (_a = this.controlBar) == null ? void 0 : _a.removeHlsCaptionButtons(true);
      }
      if ((_b = this.transcriptManager) == null ? void 0 : _b.isVisible) {
        this.transcriptManager.hideTranscript();
      }
    ...
    stagePlaylistNativeSource(src, mimeType) {
      ...
      const stagedSrc = (staged == null ? void 0 : staged.getAttribute("src")) ?? (staged == null ? void 0 : staged.src) ?? "";
      let sameSrc = false;
      if (stagedSrc) {
        try {
    ...
    iosNativePlayInUserGesture(src, mimeType) {
      ...
      const snap = () => {
        const staged = media.querySelector("source");
        const href = media.currentSrc || (staged == null ? void 0 : staged.src) || media.src || absolute;
      ...
      if (!(stagedSource == null ? void 0 : stagedSource.src) && !media.src && !absolute) {
        this.log(`iosNativePlay: no source on element — ${snap()}`, "warn");
        return false;
      }
      const attachTextTracks = () => {
        var _a, _b;
        (_b = (_a = this.playlistManager) == null ? void 0 : _a.attachIosTextTracksAfterMediaLoad) == null ? void 0 : _b.call(_a);
      };
      ...
      try {
        const promise = (renderer == null ? void 0 : renderer.rendererType) === "html5" && typeof renderer.play === "function" ? renderer.play() : media.play();
        if (promise !== void 0) {
          promise.catch((error) => {
            var _a;
            const err = error;
            ...
            (_a = this.syncPlaybackUiFromMediaElement) == null ? void 0 : _a.call(this);
          });
        }
        return true;
      } catch (error) {
    ...
    play() {
      ...
      if (playlist == null ? void 0 : playlist.isChangingTrack) {
    ...
    toggle() {
      var _a;
      const rendererType = (_a = this.renderer) == null ? void 0 : _a.rendererType;
    ...
    handleError(error) {
      ...
      const MediaErrorCtor = typeof globalThis.MediaError !== "undefined" ? globalThis.MediaError : null;
      const mediaCode = (MediaErrorCtor && error instanceof MediaErrorCtor ? error.code : void 0) ?? (error && typeof error === "object" && "code" in error ? error.code : void 0) ?? ((_a = mediaEl == null ? void 0 : mediaEl.error) == null ? void 0 : _a.code);
      if (mediaCode === 1) {
      ...
      (_b = this.syncPlaybackUiFromMediaElement) == null ? void 0 : _b.call(this);
      this.emit("error", error);
      if (this.options.onError) {
        this.options.onError.call(this, error);
      }
  ...
  var PlaylistManager = class _PlaylistManager {
    ...
    insertBeforeVideoWrapper(element) {
      ...
      const videoWrapper = ((_a = this.playlistMainElement) == null ? void 0 : _a.querySelector(".vidply-video-wrapper")) ?? this.container.querySelector(".vidply-video-wrapper");
    ...
    isTrackSourceAttached(index) {
      const track = this.tracks[index];
      if (!(track == null ? void 0 : track.src) || !this.player.renderer) {
        return false;
      }
    ...
    resolveTrackPlaybackSource(track, options) {
      ...
      const match = ((_a = track.sources) == null ? void 0 : _a.find((s) => s.src === negotiated.src)) ?? (track.src === negotiated.src ? { src: track.src, type: track.type } : null);
      this.player._fallbackSources = negotiated.fallbacks.length > 0 ? negotiated.fallbacks.map((s) => ({
        src: s.src,
        type: s.type ?? ""
      })) : [];
      return { src: negotiated.src, type: (match == null ? void 0 : match.type) ?? track.type };
    }
    ...
    attachIosTextTracksAfterMediaLoad() {
      ...
      this._iosPendingTextTracks = null;
      (_b = (_a = this.player).invalidateTrackCache) == null ? void 0 : _b.call(_a);
    ...
    completeNativeGesturePlayUi(index, track) {
      ...
      if (!this.player.element.paused) {
        (_d = (_c = this.player).hidePosterOverlay) == null ? void 0 : _d.call(_c);
      }
    }
    /**
    ...
    async loadTrack(index) {
      ...
      try {
        ...
        if (!isIOS() && ((_b = (_a = this.player) == null ? void 0 : _a.options) == null ? void 0 : _b.deferLoad) && typeof this.player.ensureLoaded === "function") {
          this.player.ensureLoaded();
        }
      } catch {
        if (loadGeneration === this._trackLoadGeneration) {
    ...
    resolveTrackPosterForArtwork(poster) {
      ...
      const resolved = typeof ((_a = this.player) == null ? void 0 : _a.resolvePosterPath) === "function" ? this.player.resolvePosterPath(poster) : poster;
    ...
    findExistingTrackArtworkElement() {
      var _a;
      const candidates = [
        ((_a = this.player) == null ? void 0 : _a.trackArtworkElement) ?? null,
