...
# Source: src/core/DescriptionSpeechManager.ts
# Regenerate scaffold: node scripts/generate-bdd-specs.mjs

@vidply @DescriptionSpeechManager
Feature: DescriptionSpeechManager
  Behaviour contract for AI-generated and human-maintained code in src/core/DescriptionSpeechManager.ts.
  Each public function or method has at least one happy-path and one guard scenario.

  @placeholder
  Scenario: Module exports are documented
    Given the DescriptionSpeechManager module from src/core/DescriptionSpeechManager.ts
