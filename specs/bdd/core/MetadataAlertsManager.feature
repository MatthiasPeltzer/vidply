...
# Source: src/core/MetadataAlertsManager.ts
# Regenerate scaffold: node scripts/generate-bdd-specs.mjs

@vidply @MetadataAlertsManager
Feature: MetadataAlertsManager
  Behaviour contract for AI-generated and human-maintained code in src/core/MetadataAlertsManager.ts.
  Each public function or method has at least one happy-path and one guard scenario.

  @placeholder
  Scenario: Module exports are documented
    Given the MetadataAlertsManager module from src/core/MetadataAlertsManager.ts
