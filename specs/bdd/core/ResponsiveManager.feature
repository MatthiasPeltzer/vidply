...
# Source: src/core/ResponsiveManager.ts
# Regenerate scaffold: node scripts/generate-bdd-specs.mjs

@vidply @ResponsiveManager
Feature: ResponsiveManager
  Behaviour contract for AI-generated and human-maintained code in src/core/ResponsiveManager.ts.
  Each public function or method has at least one happy-path and one guard scenario.

  @placeholder
  Scenario: Module exports are documented
    Given the ResponsiveManager module from src/core/ResponsiveManager.ts
