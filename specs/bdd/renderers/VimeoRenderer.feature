...
# Source: src/renderers/VimeoRenderer.ts
# Regenerate scaffold: node scripts/generate-bdd-specs.mjs

@vidply @VimeoRenderer
Feature: VimeoRenderer
  Behaviour contract for AI-generated and human-maintained code in src/renderers/VimeoRenderer.ts.
  Each public function or method has at least one happy-path and one guard scenario.

  @placeholder
  Scenario: Module exports are documented
    Given the VimeoRenderer module from src/renderers/VimeoRenderer.ts
