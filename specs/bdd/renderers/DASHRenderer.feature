...
# Source: src/renderers/DASHRenderer.ts
# Regenerate scaffold: node scripts/generate-bdd-specs.mjs

@vidply @DASHRenderer
Feature: DASHRenderer
  Behaviour contract for AI-generated and human-maintained code in src/renderers/DASHRenderer.ts.
  Each public function or method has at least one happy-path and one guard scenario.

  @placeholder
  Scenario: Module exports are documented
    Given the DASHRenderer module from src/renderers/DASHRenderer.ts
