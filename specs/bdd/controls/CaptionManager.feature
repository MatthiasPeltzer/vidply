...
# Source: src/controls/CaptionManager.ts
# Regenerate scaffold: node scripts/generate-bdd-specs.mjs

@vidply @CaptionManager
Feature: CaptionManager
  Behaviour contract for AI-generated and human-maintained code in src/controls/CaptionManager.ts.
  Each public function or method has at least one happy-path and one guard scenario.

  @placeholder
  Scenario: Module exports are documented
    Given the CaptionManager module from src/controls/CaptionManager.ts
