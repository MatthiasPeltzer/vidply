...
# Source: src/controls/KeyboardHelp.ts
# Regenerate scaffold: node scripts/generate-bdd-specs.mjs

@vidply @KeyboardHelp
Feature: KeyboardHelp
  Behaviour contract for AI-generated and human-maintained code in src/controls/KeyboardHelp.ts.
  Each public function or method has at least one happy-path and one guard scenario.

  @placeholder
  Scenario: Module exports are documented
    Given the KeyboardHelp module from src/controls/KeyboardHelp.ts
