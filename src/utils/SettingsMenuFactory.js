 ...
 */
export function showSettingsMenu(menu, button, classPrefix) {
 ...
 */
export function hideSettingsMenu(menu, button) {
    if (!menu) return;
 ...
 * @param {string} classPrefix - Class prefix
 */
export function toggleSettingsMenu(menu, button, classPrefix) {
    if (!menu) return;
 ...
 */
export function setupSettingsMenuKeyboard(menu, button, onClose) {
    if (!menu) return () => {};
